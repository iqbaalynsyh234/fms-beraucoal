...
<body>
    ...
    <div class="page-content-wrapper">
        ...
        <fieldset>
            ...
            <input class="button" type="button" value="<?php echo $this->lang->line("lcenter"); ?>" onclick="javascript: cariDanMarkerLokasi()"
             />
        </fieldset>
        ...
        <fieldset>
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                    ...
                    <input class="button" type="button" name="btncancel" id="btncancel" style="margin-bottom: 20px; background-color: red;" value=" <?php echo $this->lang->line("lreset"); ?> " onclick="location='<?= base_url() ?>geofencedrawing/manage/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>/<?php echo uniqid(); ?>'; "/>
        </fieldset>
...
<script>
    ...
    function save(str) {
        jQuery.post("<?= base_url() ?>geofencedrawing/manage/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>", {
                json: str
            },
            function(r) {
                if (r.error) {
    ...
    function removegeofence() {
        ...
        jQuery.post("<?= base_url() ?>geofence/remove/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>", {},
            function(r) {
                ...
                location = '<?= base_url() ?>geofencedrawing/manage/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>/<?php echo uniqid(); ?>';
            }, "json"
        );
