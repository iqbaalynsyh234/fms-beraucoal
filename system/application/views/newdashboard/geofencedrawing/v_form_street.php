...
<script>
	...
	function frmadd_onsubmit(frm)
	{
		...
		{
			alert("<?php echo $this->lang->line('lstreet_empty'); ?>");
			return false;
		}
	...
	function save(str)
	{
		jQuery.post("<?=base_url()?>geofencedatalive/save_street/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>", {json: str},
			function(r)
			{
				if (r.error)
				{
	...
	function removestreet_byvehicle(gid)
	{
		if (! confirm("<?php echo $this->lang->line('lconfirm_delete'); ?>")) return;
                  ...
                  <tr>
                    ...
                    <td>
                      <fieldset>
                          ...
                          <a href="<?=base_url();?>streetdata" class="btn btn-flat" type="button" ><?php echo $this->lang->line("lstreet_list"); ?> </a>
                      </fieldset>
                    </td>
                  </tr>
                </table>
