...
if(isset($key) && $key != "") { ?>
  <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDJCuzzQJJ7QHwAc6QoCoQXO4X1qQr54f0<?php echo $key;?>&libraries=drawing&callback=initialize" type="text/javascript"></script>
  <?php } else { ?>
