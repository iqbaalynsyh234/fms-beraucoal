   ...
   <!-- Elemen modal -->
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-secondary" data-dismiss="modal" style="background-color:  #00ff00;">Save</button>
        </div>
...
<script>
       ...
       function tampilkanListCreatePolygonUI() {
            ...
            for (var i = 0; i < listCreatePolygon.length; i++) {
                ...
                modalBody.innerHTML += '<tr>' +
                    ...
                    '<td><button type="button" class="btn btn-primary" onclick="editGeofenceName(' + i + ')" data-toggle="modal" data-target="#editModal" id="editGeofenceNameInput">Edit</button></td>' +
                    '</tr>';
            ...
            modalFooter.innerHTML = '<button type="button" class="btn btn-primary" onclick="simpanData()">Save</button>' +
    ...
    function simpanData() {
        // Assuming listCreatePolygon is an array of strings with coordinates

        // Prepare the data to be sent
        var dataToSave = {
            polygons: listCreatePolygon
        };
