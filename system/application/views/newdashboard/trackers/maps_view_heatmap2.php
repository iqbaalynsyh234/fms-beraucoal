...
<div class="page-content-wrapper">
    <div class="page-content">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3" id="showSearchNopol">
                                <select class="form-control select2" name="searchnopol" id="searchnopol"
                            ...
                            <div class="col-md-3" id="showSearchNOutOfHauling" style="display:none;">
                                <select class="form-control select2" name="forsearchoutofhauling"
                                    id="forsearchoutofhauling" onchange="forsearchoutofhauling()" style="width:100%;">
                                </select>
                            </div>
                  ...
                  <span class="fa fa-info"></span>
                            ...
                            <div class="col-md-2">
                                <img id="loader2" style="display:none;"
                                    src="<?php echo base_url();?>assets/images/anim_wait.gif" />
                            </div>
        ...
        <div class="row">
            <div class="col-md-12">
              ...
              right: 40px;" id="jumlahtotalInRom">
                            </p>
                        </div>
                    </div> <br>
                ...
                <div id="tableShowPort" style="width: 100%; max-height: 400px; display:none;">
                    <div class="row">
                        <div class="col-md-12">
                            <p style="position: absolute;
              right: 40px;" id="jumlahtotalInPort">
                            </p>
                        </div>
                    </div>
                ...
                <div id="tableShowPool" style="width: 100%; max-height: 400px; display:none;">
                    <div class="row">
                        <div class="col-md-12">
                            <p style="position: absolute;
              right: 40px;" id="jumlahtotalinpool">
                            </p>
                        </div>
                    </div> <br>
                ...
                <div id="tableShowPoolNew" style="width: 100%; max-height: 400px; display:none;">
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn-warning btn-sm" style="position: absolute; left: 20px; display:none;"
                                id="btnpoolback" onclick="showTablePool();">
                                <span class="fa fa-angle-left"> </span>
                                Back
                            </button>
                            <p style="position: absolute;
              right: 40px;" id="jumlahtotalinpoolnew">
                            </p>
                        </div>
                    </div> <br><br>
                            ...
                            <div id="tableShowMuatan" style="width: 100%; height: 560px; display:none;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p style="position: absolute;
                    position: absolute;
                    margin-left: -5%;" id="lastupdateconsolidated">
                                        </p>
                                    </div>
                                </div>

                                <div class="row"
                                    style="margin-top:-3%; margin-left: -5%; height: 500px; overflow-y:hidden; overflow-x:auto;">
                                    <div class="col-md-2">
                                        <ul class="timeline">
                                            <?php for ($i=30; $i > 25; $i--) {?>
                                            <li class="timeline-inverted">
                                                <div class="" id="labelvehicleonmuatan<?php echo $i ?>"
                                                    onclick="listVehicleOnKm('<?php echo $i; ?>')">KM <?php echo $i; ?>
                                                </div>
                                    ...
                                    <div class="col-md-2">
                                        <ul class="timeline">
                                            ...
                                            <li class="timeline-inverted">
                                                <?php
                          if ($i == 1) {?>
                                                <div id="labelvehicleonmuatan<?php echo $i ?>"
                                                    onclick="listVehicleOnKm('<?php echo $i; ?>')">
                          ...
                          if ($i == 1) {?>
                            ...
                            <li class="timeline-inverted">
                              ...
                              <div class="timeline-panel"></div>
                                            ...
                                            <li class="timeline-inverted">
                                                <span style="float:left; margin-left:20px; margin-top:-7px;">PORT
                                                    1</span>
                                                <span style="float:left; margin-left:-44px; margin-top:33px;">PORT
                                                    2</span>
                                ...
                                <div class="row" style="margin-top:0%; margin-left:0%;">
                                    <div class="col-md-3">
                                        <div class="btn-group text-center">
                                            <div type="button" id="labelvehicleoutofhauling" style="font-size:16px;"
                                                onclick="listOutOfHauling();"></div>
                                            <div type="button" id="vehicleoutofhauling" style="font-size:16px;"
                                                onclick="listOutOfHauling();"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <p style="position: absolute;
                    right: 40px;" id="jumlahtotaloutofhauling">
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="tableShowVehicleOffline" style="width: 100%; max-height: 400px; display:none;">
                                <div class="row">
                                    <div class="col-md-12">
                                        <p style="position: absolute;
                    right: 40px;" id="jumlahtotalOfflineVehicle">
                                        </p>
                                    </div>
                                </div> <br>
                                <div class="row" style="margin-top:0%; margin-left:0%;">
                                    <div class="col-md-2">
                                        <table class="table table-bordered" style="font-size:12px;">
                                            <tr>
                                                <td>
                                                    <div class="btn-group">
                                                        <div type="button" class="" id="labelvehicleoffline"
                                                            onclick="modalPoolFromMasterData('modalState');"></div>
                                                        <div type="button" class="" id="vehicleoffline"
                                                            onclick="modalPoolFromMasterData('modalState');"></div>
                                                    </div>
                                                </td>
                                            </tr>
                            ...
                            <div class="col-md-4" id="realtimealertshowhide">
                                ...
                                <div class="panel" id="panel_form">
                                    <header class="panel-heading" id="header-realtime-alert">
                                        Realtime Alert
                                        Show :
                                        <select class="select" name="changelimitrealtimalert"
                                            id="changelimitrealtimalert" onchange="changelimit();">
                                            <option value="10">10</option>
                                            <option value="20">20</option>
                                            <option value="30">30</option>
                                        </select>

                                        <button type="button" name="button" id="activatesound"
                                            class="btn btn-flat btn-sm" title="Sound" onclick="activatesound();"
                                            style="display:none;">
                                            <span class="fa fa-volume-up"></span>
                                        </button>

                                        <button type="button" name="button" id="activatesound2"
                                            class="btn btn-flat btn-sm" title="Sound" onclick="activatesound2();">
                                    ...
                                    <div class="panel-body" id="bar-parent10">
                                        ...
                                        <table class="table">
                                            ...
                                            <div id="summaryalertcontent"
                                                style="font-size:10px; margin-top: 1%; overflow-x: auto; height: 270px; max-height: 270px;">
                                            </div>
                                        </table>
                                    </div>
                                    <div class="panel-footer">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a href="<?php echo base_url() ?>overspeedreport" type="button"
                                                    class="btn btn-flat form-control">View More</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        function appendthecontractorlist() {
            $.post("<?php echo base_url() ?>maps/getdatacontractor", {}, function(response) {
                ...
                for (var i = 0; i < data.length; i++) {
                    html += '<option value="' + data[i].company_id + '">' + data[i].company_name +
                        '</option>';
                }
        ...
        function appendthevehiclelist() {
            ...
            if (privilegecode == 5 || privilegecode == 6) {
                ...
                if (vCompany == user_company || vehicle_id_shareto == user_company && vehicle_is_share == 1) {
                    html +=
                        '<option value="<?php echo $vehicles[$i]['vehicle_no'] ?>"><?php echo $vehicles[$i]['vehicle_no'] ?></option>';
                }
                html += '<?php } ?>';
            } else {
                html += '<option value="0">--Vehicle List</option>';
    ...
    function changevehiclelist() {
        ...
        $.post("<?php echo base_url() ?>maps/getvehiclebycontractor", {
            companyid: companyid
        }, function(response) {
            // console.log("response : ", response);
            var data = response.data;
            ...
            for (var i = 0; i < data.length; i++) {
                if (companyid == 0) {
                    ...
                    html += '<option value="' + data[i].vehicle_no + '">' + (i + 1) + ". " + data[i]
                        .vehicle_no + '</option>';
                }
            }
            $("#searchnopol").html(html);
    ...
    function initMap() {
        ...
        map = new google.maps.Map(document.getElementById("mapsnya"), {
            zoom: 14,
            center: {
                lat: parseFloat(2.1193),
                lng: parseFloat(117.4631)
            },
            mapTypeId: "satellite",
            options: {
    ...
    function simultango() {
        ...
        jQuery("#loader2").show();
        jQuery.post("<?=base_url();?>map/lastinfoall_new", {
            companyid: companyid,
            valuemapsoption: valuemapsoption
        }, function(r) {
            jQuery("#loader2").hide();
            ...
            for (var i = 0; i < r.data.length; i++) {
                arraypointheatmap2.push(new google.maps.LatLng(r.data[i].gps_latitude_real, r.data[i]
                    .gps_longitude_real));
            }
    ...
    function dataalert() {
        $.post("<?php echo base_url() ?>securityevidence/realtimealertnew", {
            intervalke: intervalke,
            lasttimealert: lasttimealert,
            ...
            if (response.code == 200) {
                ...
                var realtimealertarraysummaryreverse = realtimealertarraysummary.sort((a, b) => parseFloat(b
                    .gps_time) - parseFloat(a.gps_time));
                ...
                if (realtimealertarraysummaryreverse.length > 0) {
                    ...
                    for (var i = 0; i < realtimealertarraysummaryreverse.length; i++) {
                        ...
                        htmlsummary +=
                            '<span style="font-size:11px; color:green;" onclik="forsearchfromalert("' +
                            realtimealertarraysummaryreverse[i].vehicle_no + '")">' +
                            realtimealertarraysummaryreverse[i].vehicle_no +
                            '</span> <span style="font-size:11px; color:red;">' +
                            realtimealertarraysummaryreverse[i].gps_alert +
                            '</span> <span style="font-size:11px;">' + realtimealertarraysummaryreverse[i]
                            .gps_time +
                            '</span> </br> <a style="font-size:11px;" href="http://maps.google.com/maps?z=12&t=m&q=loc' +
                            realtimealertarraysummaryreverse[i].gps_latitude_real + ',' +
                            realtimealertarraysummaryreverse[i].gps_longitude_real + '" target="_blank">' +
                            " " + realtimealertarraysummaryreverse[i].position +
                            ' </a> <span style="font-size:11px; color:black;">' + 'Speed : ' +
                            realtimealertarraysummaryreverse[i].gps_speed +
                            ' Kph </span> <span style="font-size:11px; color:red;">' + 'Limit : ' +
                            realtimealertarraysummaryreverse[i].gps_speed_limit + ' Kph </span> ' +
                            '<span style="font-size:11px; color:black;">' + realtimealertarraysummaryreverse[i]
                            .jalur_name + '</span> </br><hr>';
                    }
    ...
    function searchEqualism(vehicleno, gpstime) {
        for (var i = 0; i < realtimealertarraysummary.length; i++) {
            if (realtimealertarraysummary[i].vehicle_no == vehicleno && realtimealertarraysummary[i].gps_time ==
                gpstime) {
                status = true;
                return status;
            }
    ...
    function getalertnowsample(devid) {
        ...
        for (var i = 0; i < reversearraysummary.length; i++) {
            htmlsummary += '<span style="font-size:12px; color:green;">' + reversearraysummary[0].vehicle_no +
                '</span> <span style="font-size:12px; color:red;">' + reversearraysummary[0].vehicle_alert +
                '</span> <span style="font-size:12px;">' + reversearraysummary[0].vehicle_alert_time +
                '</span> <a style="font-size:12px;" href="http://maps.google.com/maps?z=12&t=m&q=loc' + "-302321" +
                ',' + "1000023123" + '" target="_blank">' + " " + reversearraysummary[i].position +
                ' </a> <span style="font-size:12px; color:red;">' + 'Limit : ' + reversearraysummary[0]
                .gps_speed_limit + '</span> </br>';
        }
        $("#summaryalertcontent").html(htmlsummary);
        ...
        if (deviceid == 0) {
            ...
            $.post("<?php echo base_url() ?>maps/forsearchvehicle", data, function(response) {
                ...
                if (response.code == 400) {
                    ...
                    if (response[0].drivername) {
                        ...
                        if (response[0].driverimage) {
                            ...
                            if (response[0].driverimage != 0) {
                                ...
                                var detaildriver =
                                    '<img src="<?php echo base_url().$this->config->item("dir_photo");?>' +
                                    response[0].driverimage + '" width="100px;" height="100px;">';
                            } else {
                    ...
                    var center = {
                        lat: parseFloat(response[0].auto_last_lat),
                        lng: parseFloat(response[0].auto_last_long)
                    };
                    ...
                    if (response[0].auto_last_road == "muatan") {
                        ...
                        laststatus2 =
                            '<h5 class="text-medium full-width"><span class="label label-sm label-success">GPS Online</span></h5>';
                    ...
                    titlemarker += 'Coord : ' + response[0].auto_last_lat + ", " + response[0].auto_last_long +
                        '</br>';
                    ...
                    if (response[0].vehicle_rom_name != null) {
                        titlemarker += 'Last Cargo : ' + response[0].vehicle_rom_name + ' ' + response[0]
                            .vehicle_rom_time + '</br>';
                    }
                    titlemarker += '<div onclick="tutupinformasi(' + response[0].vehicle_id +
                        ')" style="color:blue;cursor:pointer;">Tutup Informasi</div>';
                    ...
                    markernya = new google.maps.Marker({
                        map: map,
                        icon: icon,
                        position: new google.maps.LatLng(parseFloat(response[0].auto_last_lat),
                            parseFloat(response[0].auto_last_long)),
    ...
    function forsearchfromalert(deviceid) {
        ...
        $.post("<?php echo base_url() ?>maps/forsearchvehicle", data, function(response) {
            ...
            if (response.code == 400) {
                ...
                titlemarker += devicestatus;
                titlemarker += 'Ritase : ' + ritasefix + '</br>';
                titlemarker += '<div onclick="DeleteMarkers(' + response[0].vehicle_id +
                    ')" style="color:blue;cursor:pointer;">Tutup Informasi</div>';
                // titlemarker += '<a href="<?php echo base_url()?>maps/tracking/"' + response[0].vehicle_id + '"target="_blank">Tracking</a> </br>';
                // titlemarker +=   lct + imglct;
                titlemarker += '</td>';
                ...
                markernya = new google.maps.Marker({
                    map: map,
                    icon: icon,
                    position: new google.maps.LatLng(parseFloat(response[0].auto_last_lat), parseFloat(
                        response[0].auto_last_long)),
                    title: response[0].vehicle_no,
                    // + ' - ' + value.vehicle_name + value.driver + "\n" +
                    //   "GPS Time : " + value.gps.gps_date_fmt + " " + value.gps.gps_time_fmt + "\n" + value.gps.georeverse.display_name + "\n" + value.gps.gps_latitude_real_fmt + ", " + value.gps.gps_longitude_real_fmt + "\n" +
                    //   "Speed : " + value.gps.gps_speed + " kph",
    ...
    function showHeatmap() {
        ...
        jQuery("#loader2").show();
        var companyid = $("#contractor").val();
        $.post("<?php echo base_url() ?>maps/showmapsafter", {
            companyid: companyid
        }, function(response) {
            jQuery("#loader2").hide();
            ...
            for (var i = 0; i < vehicle.length; i++) {
                htmlchangeVList.options[htmlchangeVList.options.length] = new Option(vehicle[i].vehicle_no,
                    vehicle[i].vehicle_no);
            }

            for (var i = 0; i < vehicle.length; i++) {
                arraypointheatmap.push(new google.maps.LatLng(vehicle[i].auto_last_lat, vehicle[i]
                    .auto_last_long));
            }
    ...
    function showTableMuatan() {
        ...
        $.post("<?php echo base_url() ?>maps/km_quickcount_new", {
            companyid: companyid
        }, function(response) {
            jQuery("#loader2").hide();
            ...
            for (var j = 0; j < dataPortfix.length; j++) {
                ...
                if (j == (dataPortfix.length - 1)) {
                    ...
                    htmlPortinQuickCount += '<td><div id="jumlahportbibplusturunan' + j + '"><b>' + dataPortfix[
                        j][1] + '&nbsp;|&nbsp;</b></div><td>';
                } else {
                    if (dataPortfix[j][0] == "PORT BIB") {
                        jumlahDataInPortBIB += dataPortfix[j][1];
            ...
            $("#jumlahportbibplusturunan0").html('<div id="jumlahportbibplusturunan0"><b>' + (
                jumlahDataInPortBIB + jumlahDataInCP) + '&nbsp;|&nbsp;</b></div>');
            ...
            $("#jumlahportbibplusturunan1").html('<div id="jumlahportbibplusturunan1"><b>' + (
                    jumlahDataInPortBIR + jumlahDataInANTBIR) + '&nbsp;|&nbsp;</b> <b>TOTAL : ' + (
                    jumlahDataInPortBIB + jumlahDataInCP + jumlahDataInPortBIR + jumlahDataInANTBIR) +
                '</b></div>');
            ...
            for (var i = 0; i < sizekosongan2; i++) {
                ...
                var jumlahfix = arraydatakosongan2[i][
                    1
                ]; //arraydatamuatan[i][1]; //30+i; //arraydatamuatan[i][1];
            ...
            for (var i = 0; i < sizekosongan; i++) {
                ...
                var jumlahfix = arraydatakosongan[i][
                    1
                ]; //arraydatamuatan[i][1]; //30+i; //arraydatamuatan[i][1];
                ...
                for (var j = 0; j < totalkmallkosongan; j++) {
                    ...
                    if (kmlist == mapsetting_name) {
                        var mapsetting_middle_limit_allkmkosongan = dataallkmkosongan[j]
                            .mapsetting_middle_limit;
                    ...
                    if (jumlahfix >= mapsetting_middle_limit_allkmkosongan && jumlahfix <
                        mapsetting_top_limit_allkmkosongan) {
                        $("#labelvehicleonmuatan" + i).addClass('timeline-badge btn btn-primary btn-lg');
                        $("#vehicleonkosongan" + i).addClass(
                            'timeline-badge2 btn btn-warning btn-md btn-circle');
                    } else if (jumlahfix >= mapsetting_top_limit_allkmkosongan) {
                        $("#labelvehicleonmuatan" + i).addClass('timeline-badge btn btn-primary btn-lg');
                        $("#vehicleonkosongan" + i).addClass(
                            'timeline-badge2 btn btn-danger btn-md btn-circle');
                    } else {
                        $("#labelvehicleonmuatan" + i).addClass('timeline-badge btn btn-primary btn-lg');
                        $("#vehicleonkosongan" + i).addClass(
                            'timeline-badge2 btn btn-success btn-md btn-circle');
                    }
            ...
            for (var i = 0; i < sizemuatan2; i++) {
                ...
                var jumlahfix = arraydatamuatan2[i][
                    1
                ]; //arraydatamuatan[i][1]; //30+i; //arraydatamuatan[i][1];
                ...
                for (var j = 0; j < totalonlykm1muatan; j++) {
                    if (dataonlykm1muatan[0].mapsetting_bottom_limit != 0) {
                        var mapsetting_bottom_limit_allkmkosongan = dataonlykm1muatan[0]
                            .mapsetting_bottom_limit;
                    } else {
                        var mapsetting_middle_limit_allkmkosongan = 5;
                    }

                    if (dataonlykm1muatan[0].mapsetting_middle_limit != 0) {
                        var mapsetting_middle_limit_allkmkosongan = dataonlykm1muatan[0]
                            .mapsetting_middle_limit;
                    } else {
                    ...
                    if (portbibmuatan < mapsetting_bottom_limit_allkmkosongan) {
                        ...
                        $("#port_bib_muatan").addClass('timeline-badge5 btn btn-danger btn-md btn-circle');
                    } else if (portbibmuatan >= mapsetting_bottom_limit_allkmkosongan && portbibmuatan <
                        mapsetting_middle_limit_allkmkosongan) {
                        $("#port_bib_muatan").removeClass();
                        $("#port_bib_muatan").addClass('timeline-badge5 btn btn-warning btn-md btn-circle');
                    } else if (portbibmuatan >= mapsetting_middle_limit_allkmkosongan && portbibmuatan <
                        mapsetting_top_limit_allkmkosongan) {
                        $("#port_bib_muatan").removeClass();
                        $("#port_bib_muatan").addClass('timeline-badge5 btn btn-success btn-md btn-circle');
                    } else {
                    ...
                    if (portbirmuatan < mapsetting_bottom_limit_allkmkosongan) {
                        ...
                        $("#port_bir_muatan").addClass('timeline-badge7 btn btn-danger btn-md btn-circle');
                    } else if (portbirmuatan >= mapsetting_bottom_limit_allkmkosongan && portbirmuatan <
                        mapsetting_middle_limit_allkmkosongan) {
                        $("#port_bir_muatan").removeClass();
                        $("#port_bir_muatan").addClass('timeline-badge7 btn btn-warning btn-md btn-circle');
                    } else if (portbirmuatan >= mapsetting_middle_limit_allkmkosongan && portbirmuatan <
                        mapsetting_top_limit_allkmkosongan) {
                        $("#port_bir_muatan").removeClass();
                        $("#port_bir_muatan").addClass('timeline-badge7 btn btn-success btn-md btn-circle');
                    } else {
            ...
            for (var i = 0; i < sizemuatan; i++) {
                ...
                for (var j = 0; j < totalkmallmuatan; j++) {
                    ...
                    if (jumlahfix >= mapsetting_middle_limit_allkmmuatan && jumlahfix <
                        mapsetting_top_limit_allkmmuatan) {
                        $("#labelvehicleonmuatan" + i).addClass('timeline-badge btn btn-primary btn-lg');
            ...
            $("#lastupdateconsolidated").html("Kosongan : " + (totalKosongan + totalKosongan2) +
                " || Muatan : " + (totalMuatan + totalMuatan2) + " || Total : " + (totalKosongan +
                    totalMuatan + totalKosongan2 + totalMuatan2) + " || Last Refresh : " + response
                .lastcheck);
    ...
    function listVehicleOnKm(idkm) {
        ...
        $.post("<?php echo base_url() ?>maps/getlistinkm", {
            idkm: idkm,
            ...
            if (dataKosonganfix.length == 0) {
                ...
                for (var i = 0; i < dataKosonganfix.length; i++) {
                    ...
                    htmlkosongan += '<tr>';
                    htmlkosongan += '<td style="font-size:12px;color:black"><span style="color:black;">' + (i +
                        1) + '</span>';
                    htmlkosongan += '<td style="font-size:12px;color:black"><span style="color:black;">' +
                        dataKosonganfix[i].vehicle_no + " " + dataKosonganfix[i].vehicle_name + '</span>';
                    htmlkosongan += '<td style="font-size:12px;color:black"><span style="color:black;">' +
                        dataKosonganfix[i].auto_last_positionfix + '</span>';
                    htmlkosongan +=
                        '<td align="center" style="font-size:12px;color:black"><span style="color:black;">' +
                        lastenginefix + '</span>';
                    htmlkosongan +=
                        '<td align="center" style="font-size:12px;color:black"><span style="color:black;">' +
                        speedkmfix + '</span>';
                    htmlkosongan += '<td style="font-size:12px;color:black"><span style="color:black;">' +
                        dataKosonganfix[i].auto_last_lat + "," + dataKosonganfix[i].auto_last_long + '</span>';
                    htmlkosongan += '</tr>';
                }
                htmlkosongan += '</table>';
            ...
            if (dataMuatanfix.length == 0) {
                ...
                for (var i = 0; i < dataMuatanfix.length; i++) {
                    ...
                    htmlmuatan += '<tr>';
                    htmlmuatan += '<td style="font-size:12px;color:black"><span style="color:black;">' + (i +
                        1) + '</span>';
                    htmlmuatan += '<td style="font-size:12px;color:black"><span style="color:black;">' +
                        dataMuatanfix[i].vehicle_no + " " + dataMuatanfix[i].vehicle_name + '</span>';
                    htmlmuatan +=
                        '<td align="center" style="font-size:12px;color:black"><span style="color:black;">' +
                        dataMuatanfix[i].auto_last_positionfix + '</span>';
                    htmlmuatan +=
                        '<td align="center" style="font-size:12px;color:black"><span style="color:black;">' +
                        lastenginefix + '</span>';
                    htmlmuatan +=
                        ...
                        speedkmfix + '</span>';
                    htmlmuatan += '<td style="font-size:12px;color:black"><span style="color:black;">' +
                        dataMuatanfix[i].auto_last_lat + "," + dataMuatanfix[i].auto_last_long + '</span>';
                    htmlmuatan += '</tr>';
                }
                htmlmuatan += '</table>';
    ...
    function showTableRom() {
        ...
        jQuery("#loader2").show();
        $.post("<?php echo base_url() ?>maps/getstreetautomaticbycompanyid", {
            typeofstreet: 3,
            companyid: companyid
        }, function(response) {
            jQuery("#loader2").hide();
            ...
            for (var i = 0; i < totaldata; i++) {
                ...
                htmlrom += '<div class="col-xl-3 col-md-6 col-12" onclick="listVehicleOnRom(' + allStreet[i]
                    .street_id + ')" style="cursor : pointer;">';
                ...
                htmlrom +=
                    '<i class="material-icons" style="font-size:50px; padding-top:10px;">my_location</i>';
                htmlrom += '</span>';
                htmlrom += '<div class="info-box-content">';
                htmlrom += '<span class="info-box-text" style="font-size:15px;">' + datainrom[i][0] + '</span>';
                htmlrom += '<span class="info-box-number" style="font-size:22px;"><b>' + datainrom[i][1] +
                    '</b></span>';
                htmlrom += '</div>';
                htmlrom += '</div>';
                htmlrom += '</div>';
    ...
    function romlist_simultan() {
        ...
        $.post("<?php echo base_url() ?>maps/getstreetautomaticbycompanyid", {
            ...
            $("#contentrom").html(htmlrom);
            $("#jumlahtotalInRom").html("Total : " + jumlahtotalInRom + " || Last Refresh : " + response
                .lastcheck);
            $("#jumlahtotalInRom").show();
        }, "json");
    }
    ...
    function listVehicleOnRom(id) {
        var contractor = $("#contractor").val();
        $.post("<?php echo base_url() ?>maps/getlistinrom", {
            idrom: id,
            contractor: contractor
        }, function(response) {
            ...
            if (datafix.length > 0) {
                ...
                for (var i = 0; i < datafix.length; i++) {
                    ...
                    htmlpool += '<tr>';
                    htmlpool += '<td style="font-size:12px;color:black"><span style="color:black;">' + (i + 1) +
                        '</span>';
                    htmlpool += '<td style="font-size:12px;color:black"><span style="color:black;">' + datafix[
                        i].vehicle_no + " " + datafix[i].vehicle_name + '</span>';
                    htmlpool +=
                        '<td align="center" style="font-size:12px;color:black"><span style="color:black;">' +
                        lastenginefix + '</span>';
                    htmlpool +=
                        ...
                        speedromfix + '</span>';
                    htmlpool += '<td style="font-size:12px;color:black"><span style="color:black;">' + datafix[
                        i].auto_last_lat + "," + datafix[i].auto_last_long + '</span>';
                    htmlpool += '</tr>';
                }
                htmlpool += '</table>';
        ...
        $.post("<?php echo base_url() ?>maps/getstreetautomaticbycompanyid", {
            ...
            for (var j = 0; j < dataLimitInPort.length; j++) {
                if (datainport[0][0] == dataLimitInPort[j].mapsetting_name_alias) {
                    ...
                    if (jumlahtotalInPortBib > middle_limit_in_port && jumlahtotalInPortBib <
                        top_limit_in_port) {
                        htmlportbib += '<h3 class="level-3 info-box bg-warning" onclick="listVehicleOnPort(' +
                            allStreet[0].street_id + ')" style="cursor : pointer;">';
                    } else if (jumlahtotalInPortBib >= top_limit_in_port) {
                        htmlportbib += '<h3 class="level-3 info-box bg-danger" onclick="listVehicleOnPort(' +
                            allStreet[0].street_id + ')" style="cursor : pointer;">';
                    } else {
                        htmlportbib += '<h3 class="level-3 info-box bg-blue" onclick="listVehicleOnPort(' +
                            allStreet[0].street_id + ')" style="cursor : pointer;">';
                    }
                }
            }
            htmlportbib +=
                '<span class="info-box-icon push-bottom" style="margin-top:0%; background-color: red;">';
            htmlportbib +=
            ...
            htmlportbib += '<span class="info-box-number" style="font-size:20px;">' + datainport[0][0] +
                '</span>';
            htmlportbib += '<span class="info-box-text" style="font-size:30px;"><b>' + jumlahtotalInPortBib +
                '</b></span>';
            htmlportbib += '</div>';
            htmlportbib += '</h3>';
                ...
                for (var j = 0; j < dataLimitInPort.length; j++) {
                    if (datainport[i][0] == dataLimitInPort[j].mapsetting_name_alias) {
                        ...
                        if (datainport[i][1] > middle_limit_in_port && datainport[i][1] < top_limit_in_port) {
                            htmlportbib +=
                                '<h4 class="level-4 rectangle bg-warning" onclick="listVehicleOnPort(' +
                                allStreet[i].street_id + ')" style="cursor : pointer;">';
                        } else if (datainport[i][1] >= top_limit_in_port) {
                            htmlportbib +=
                                '<h4 class="level-4 rectangle bg-danger" onclick="listVehicleOnPort(' +
                                allStreet[i].street_id + ')" style="cursor : pointer;">';
                        } else {
                            htmlportbib += '<h4 class="level-4 rectangle bg-blue" onclick="listVehicleOnPort(' +
                                allStreet[i].street_id + ')" style="cursor : pointer;">';
                        }
                    }
                }
                htmlportbib += '<span class="info-box-icon push-bottom" style="margin-top:0%;">';
                htmlportbib += '<img src="<?php echo base_url();?>/assets/bib/images/bibcp' + i +
                    '.png" style="font-size:50px;">';
                htmlportbib += '</span>';
                htmlportbib += '<div class="info-box-content" style="color:white;">';
                // htmlportbib += '<span class="info-box-text" style="font-size:15px;">'+datainport[i][0]+'</span>';
                htmlportbib += '<span class="info-box-text text-center" style="font-size:30px;"><b>' +
                    datainport[i][1] + '</b></span>';
            ...
            for (var j = 0; j < dataLimitInPort.length; j++) {
                if (datainport[0][0] == dataLimitInPort[j].mapsetting_name_alias) {
                    ...
                    if (jumlahtotalInPortBir > middle_limit_in_port && jumlahtotalInPortBir <
                        top_limit_in_port) {
                        htmlportbir += '<h3 class="level-3 info-box bg-warning" onclick="listVehicleOnPort(' +
                            allStreet[9].street_id + ')" style="cursor : pointer;">';
                    } else if (jumlahtotalInPortBir >= top_limit_in_port) {
                        htmlportbir += '<h3 class="level-3 info-box bg-danger" onclick="listVehicleOnPort(' +
                            allStreet[9].street_id + ')" style="cursor : pointer;">';
                    } else {
                        htmlportbir += '<h3 class="level-3 info-box bg-blue" onclick="listVehicleOnPort(' +
                            allStreet[9].street_id + ')" style="cursor : pointer;">';
                    }
                }
            }
            ...
            htmlportbir += '<span class="info-box-number" style="font-size:20px;">' + datainport[9][0] +
                '</span>';
            htmlportbir += '<span class="info-box-text" style="font-size:30px;"><b>' + jumlahtotalInPortBir +
                '</b></span>';
            htmlportbir += '</div>';
            htmlportbir += '</h3>';
                ...
                for (var j = 0; j < dataLimitInPort.length; j++) {
                    if (datainport[i][0] == dataLimitInPort[j].mapsetting_name_alias) {
                        ...
                        if (datainport[i][1] > middle_limit_in_port && datainport[i][1] < top_limit_in_port) {
                            ...
                            htmlportbir += '<h4 class="level-4 rectangle bg-blue" onclick="listVehicleOnPort(' +
                                allStreet[i].street_id + ')" style="cursor : pointer;">';
                        }
                    }
                }
                htmlportbir += '<span class="info-box-icon push-bottom" style="margin-top:0%;">';
                htmlportbir += '<img src="<?php echo base_url();?>/assets/bib/images/birls' + i +
                    '.png" style="font-size:50px;">';
                htmlportbir += '</span>';
                htmlportbir += '<div class="info-box-content" style="color:white;">';
                htmlportbir += '<span class="info-box-text text-center" style="font-size:30px;"><b>' +
                    datainport[i][1] + '</b></span>';
            ...
            for (var j = 0; j < dataLimitInPort.length; j++) {
                if (datainport[15][0] == dataLimitInPort[j].mapsetting_name_alias) {
                    ...
                    if (datainport[15][1] > middle_limit_in_port && datainport[15][1] < top_limit_in_port) {
                        htmlportbbc += '<h3 class="level-3 info-box bg-warning" onclick="listVehicleOnPort(' +
                            allStreet[15].street_id + ')" style="cursor : pointer;">';
                    } else if (datainport[15][1] >= top_limit_in_port) {
                        htmlportbbc += '<h3 class="level-3 info-box bg-danger" onclick="listVehicleOnPort(' +
                            allStreet[15].street_id + ')" style="cursor : pointer;">';
                    } else {
                        htmlportbbc += '<h3 class="level-3 info-box bg-blue" onclick="listVehicleOnPort(' +
                            allStreet[15].street_id + ')" style="cursor : pointer;">';
                    }
                }
            }
            ...
            htmlportbbc += '<span class="info-box-number" style="font-size:20px;">' + datainport[15][0] +
                '</span>';
            htmlportbbc += '<span class="info-box-text" style="font-size:30px;"><b>' + datainport[15][1] +
                '</b></span>';
            htmlportbbc += '</div>';
            htmlportbbc += '</h3>';
            htmlportbbc += '</li>';
            ...
            for (var j = 0; j < dataLimitInPort.length; j++) {
                if (datainport[16][0] == dataLimitInPort[j].mapsetting_name_alias) {
                    ...
                    if (datainport[16][1] > middle_limit_in_port && datainport[16][1] < top_limit_in_port) {
                        htmlporttia += '<h3 class="level-3 info-box bg-warning" onclick="listVehicleOnPort(' +
                            allStreet[16].street_id + ')" style="cursor : pointer;">';
                    } else if (datainport[16][1] >= top_limit_in_port) {
                        htmlporttia += '<h3 class="level-3 info-box bg-danger" onclick="listVehicleOnPort(' +
                            allStreet[16].street_id + ')" style="cursor : pointer;">';
                    } else {
                        htmlporttia += '<h3 class="level-3 info-box bg-blue" onclick="listVehicleOnPort(' +
                            allStreet[16].street_id + ')" style="cursor : pointer;">';
                    }
                }
            }
            ...
            htmlporttia += '<span class="info-box-number" style="font-size:20px;">' + datainport[16][0] +
                '</span>';
            htmlporttia += '<span class="info-box-text" style="font-size:30px;"><b>' + datainport[16][1] +
                '</b></span>';
            htmlporttia += '</div>';
            htmlporttia += '</h3>';
            htmlporttia += '</li>';
    ...
    function portlist_simultan() {
        ...
        $.post("<?php echo base_url() ?>maps/getstreetautomaticbycompanyid", {
            ...
            $("#jumlahtotalInPort").html("Total : " + jumlahtotalInPort + " || Last Refresh : " + response
                .lastcheck);
            $("#jumlahtotalInPort").show();
        }, "json");
    }
    ...
    function listVehicleOnPort(id) {
        var contractor = $("#contractor").val();
        $.post("<?php echo base_url() ?>maps/getlistinport", {
            idport: id,
            contractor: contractor
        }, function(response) {
    ...
    function showTablePool() {
        ...
        jQuery("#loader2").show();
        $.post("<?php echo base_url() ?>maps/getpoolnew", {
            typeofstreet: 2,
            companyid: companyid
        }, function(response) {
            ...
            for (var i = 0; i < totaldata; i++) {
                ...
                htmlpool += '<div class="col-xl-3 col-md-6 col-12" onclick="getPoolByParent(' + allcompany[i]
                    .company_id + ')" style="cursor : pointer;">';
                htmlpool += '<div class="info-box bg-blue">';
                htmlpool += '<span class="info-box-icon push-bottom" style="margin-top:4%;">';
                htmlpool +=
                    '<i class="material-icons" style="font-size:50px; padding-top:10px;">store_mall_directory</i>';
                htmlpool += '</span>';
                htmlpool += '<div class="info-box-content">';
                htmlpool += '<span class="info-box-text" style="font-size:15px;">POOL ' + datainpool[i][0] +
                    '</span>';
                htmlpool += '<span class="info-box-number" style="font-size:22px;"><b>' + datainpool[i][1] +
                    '</b></span>';
                htmlpool += '</div>';
                htmlpool += '</div>';
                htmlpool += '</div>';
            ...
            htmlpool +=
                '<div class="col-xl-3 col-md-6 col-12" onclick="getPoolOther()" style="cursor : pointer;">';
            htmlpool += '<div class="info-box bg-blue">';
            htmlpool += '<span class="info-box-icon push-bottom" style="margin-top:4%;">';
            htmlpool +=
                '<i class="material-icons" style="font-size:50px; padding-top:10px;">store_mall_directory</i>';
            ...
            htmlpool += '<span class="info-box-number" style="font-size:22px;"><b>' + response.dataoutofhauling
                .outofhauling + '</b></span>';
            htmlpool += '</div>';
            htmlpool += '</div>';
            htmlpool += '</div>';
    ...
    function poollist_simultan_new() {
        ...
        $.post("<?php echo base_url() ?>maps/getpoolnew", {
            ...
            $("#contentpoolnew").html(htmlpool);
            $("#jumlahtotalinpoolnew").html("Total : " + jumlahtotalinpool + " || Last Refresh : " + response
                .lastcheck);
            $("#jumlahtotalinpoolnew").show();
            intervalpoollist = setInterval(poollist_simultan_new, 15000);
        }, "json");
    ...
    function getPoolOther() {
        ...
        var companyid = $("#contractor").val();
        jQuery("#loader2").show();
        $.post("<?php echo base_url() ?>maps/getPoolOther", {
            companyid: companyid
        }, function(response) {
            jQuery("#loader2").hide();
            ...
            for (var i = 0; i < totaldataothers; i++) {
                jumlahtotalinpool += datainpool[i][1];
                htmlpool += '<div class="col-xl-3 col-md-6 col-12" onclick="listOutOfHaulingByContractor(' +
                    datacompany[i].company_id + ')" style="cursor : pointer;">';
                htmlpool += '<div class="info-box bg-blue">';
                htmlpool += '<span class="info-box-icon push-bottom" style="margin-top:4%;">';
                htmlpool +=
                    '<i class="material-icons" style="font-size:50px; padding-top:10px;">store_mall_directory</i>';
                htmlpool += '</span>';
                htmlpool += '<div class="info-box-content">';
                htmlpool += '<span class="info-box-text" style="font-size:15px;">' + datainpool[i][0] +
                    '</span>';
                htmlpool += '<span class="info-box-number" style="font-size:22px;"><b>' + datainpool[i][1] +
                    '</b></span>';
                htmlpool += '</div>';
    ...
    function getVehicleByPool(id) {
        var contractor = $("#contractor").val();
        $.post("<?php echo base_url() ?>maps/vehicleonpool", {
            idpool: id,
            contractor: contractor
        }, function(response) {
    ...
    function getPoolByParent(id) {
        ...
        $("#poolparentID").val(id);
        var contractor = $("#contractor").val();
        $.post("<?php echo base_url() ?>maps/getChildPool", {
            poolparent: id,
            contractor: contractor
        }, function(response) {
            ...
            for (var i = 0; i < totaldata; i++) {
                jumlahtotalinpool += datainpool[i][1];
                htmlpool += '<div class="col-xl-3 col-md-6 col-12" onclick="getVehicleByPool(' + allStreet[i]
                    .street_id + ')" style="cursor : pointer;">';
                htmlpool += '<div class="info-box bg-blue">';
                htmlpool += '<span class="info-box-icon push-bottom" style="margin-top:4%;">';
                htmlpool +=
            ...
            $("#jumlahtotalinpoolnew").html("Total : " + jumlahtotalinpool);
            $("#jumlahtotalinpoolnew").show();
            intervalpoollist = setInterval(function() {
                poolinparent_simultan(id);
            }, 15000);
        }, "json");
    }
    ...
    function showOutOfHauling() {
        ...
        var companyid = $("#contractor").val();
        jQuery("#loader2").show();
        $.post("<?php echo base_url() ?>maps/outOfHauling_quickcount", {
            companyid: companyid
        }, function(response) {
            jQuery("#loader2").hide();
            ...
            htmlchangeVList.options[htmlchangeVList.options.length] = new Option('Vehicle List Out Of Hauling',
                "0");
            for (var i = 0; i < vehicle.length; i++) {
                htmlchangeVList.options[htmlchangeVList.options.length] = new Option(vehicle[i].vehicle_no,
                    vehicle[i].vehicle_no);
            ...
            for (i = 0; i < vehicle.length; i++) {
                var position = new google.maps.LatLng(parseFloat(objoutofhauling[i].auto_last_lat), parseFloat(
                    objoutofhauling[i].auto_last_long));
                ...
                google.maps.event.addListener(marker, 'click', (function(marker, i) {
                    return function() {
                        ...
                        $.post("<?php echo base_url() ?>maps/getdetailbydevid", data, function(
                            response) {
                            infowindowkedua.close();
                            ...
                            var string = response[0].vehicle_no + ' - ' + response[0]
                                .vehicle_name + "<br>" +
                                "GPS Time : " + response[0].auto_last_update +
                                "<br>Position : " + addressfix + "<br>" +
                                "Coord : <a href='https://www.google.com/maps/search/?api=1&query=" +
                                response[0].auto_last_lat + ',' + response[0]
                                .auto_last_long + "' target='_blank'>" + response[0]
                                .auto_last_lat + ',' + response[0].auto_last_long +
                                "</a></span></br>" +
                                // "Coord : " + response[0].auto_last_lat + ", " + response[0].auto_last_long + "<br>" +
                                "Engine : " + response[0].auto_last_engine + "<br>" +
                                "Speed : " + rounded + " kph" + "<br> Ritase : " +
                                ritasefix + "</br>" +
                                "<div onclick='closeWindowOnMarkerOOH();' style='color:blue;cursor:pointer;'>Tutup Informasi</div>";
                            // "<a href='<?php echo base_url()?>maps/tracking/" + response[0].vehicle_id + "' target='_blank'>Tracking</a>";
    ...
    function listOutOfHauling() {
        var contractor = $("#contractor").val();
        $.post("<?php echo base_url() ?>maps/getlistoutofhauling", {
            contractor: contractor
        }, function(response) {
            ...
            if (datafix.length > 0) {
                ...
                for (var i = 0; i < datafix.length; i++) {
                    ...
                    htmlpool +=
                        '<td align="center" style="font-size:12px;color:black"><span style="color:black;">' +
                        datafix[i].auto_last_positionfix + '</span>';
                    htmlpool +=
                        '<td style="font-size:12px;color:black"><span style="color:black;"><a href="https://maps.google.com/?q=' +
                        datafix[i].auto_last_lat + "," + datafix[i].auto_last_long + '" target="_blank">' +
                        datafix[i].auto_last_lat + "," + datafix[i].auto_last_long + '</a></span>';
                    htmlpool += '</tr>';
                }
                htmlpool += '</table>';
                $("#modalStateContent").html(htmlpool);
    ...
    function listOutOfHaulingByContractor(id) {
        $.post("<?php echo base_url() ?>maps/getlistoutofhaulingByContractor", {
            contractor: id
        }, function(response) {
            ...
            if (datafix.length > 0) {
                ...
                for (var i = 0; i < datafix.length; i++) {
                    ...
                    htmlpool +=
                        '<td align="center" style="font-size:12px;color:black"><span style="color:black;">' +
                        datafix[i].auto_last_engine + '</span>';
                    htmlpool +=
                        '<td align="center" style="font-size:12px;color:black"><span style="color:black;">' +
                        speedfix + '</span>';
                    htmlpool +=
    ...
    function showOfflineVehicle() {
        ...
        var contractor = $("#contractor").val();
        jQuery("#loader2").show();
        $.post("<?php echo base_url() ?>maps/offlinevehicle_quickcount", {
            contractor: contractor
        }, function(response) {
            jQuery("#loader2").hide();
            ...
            if (datafix.length > 0) {
                ...
                for (var i = 0; i < datafix.length; i++) {
                    ...
                    htmlofflinevehicle += '<tr>';
                    htmlofflinevehicle += '<td style="font-size:12px;color:black"><span style="color:black;">' +
                        (i + 1) + '</span>';
                    htmlofflinevehicle += '<td style="font-size:12px;color:black"><span style="color:black;">' +
                        datafix[i].vehicle_no + " " + datafix[i].vehicle_name + '</span>';
    ...
    function standardMaps() {
        ...
        jQuery("#loader2").show();
        $.post("<?php echo base_url() ?>maps/mapsstandard", {
            companyid: companyid
        }, function(response) {
            jQuery("#loader2").hide();
            ...
            for (i = 0; i < objmapsstandard.length; i++) {
                var position = new google.maps.LatLng(parseFloat(objmapsstandard[i].auto_last_lat), parseFloat(
                    objmapsstandard[i].auto_last_long));
                bounds.extend(position);
                    ...
                    return function() {
                        ...
                        $.post("<?php echo base_url() ?>maps/getdetailbydevid", data, function(
                            ...
                            if (response[0].auto_last_road) {
                                if (response[0].auto_last_road == "muatan") {
                                    if (rounded == 0 && response[0].auto_last_engine ==
                                        "ON") {
                                        lastenginefix = "ON";
                                        laststatus = 'GPS Online';
                                        laststatus2 =
                            ...
                            var string = response[0].vehicle_no + ' - ' + response[0]
                                .vehicle_name + "<br>" +
                                "GPS Time : " + response[0].auto_last_update +
                                "<br>Position : " + addressfix + "<br> Jalur : " +
                                response[0].auto_last_road + "<br>" +
                                "Coord : " + response[0].auto_last_lat + ", " +
                                response[0].auto_last_long + "<br>" +
                                "Engine : " + lastenginefix + "<br>" +
                            ...
                            google.maps.event.addListener(marker, 'click', function(
                                ...
                                var addresssplit = response[0]
                                    .auto_last_position.split(" ");
                                var inarea = response[0].auto_last_position
                                    .split(",");
                                var addressfix = bibarea.includes(addresssplit[
                                    0]);
                                if (addressfix) {
                                    var addressfix = inarea[0];
                                } else {
                                    var addressfix = response[0]
                                        .auto_last_position;
                                }
                                ...
                                var string = response[0].vehicle_no + ' - ' +
                                    response[0].vehicle_name + "<br>" +
                                    "GPS Time : " + response[0]
                                    .auto_last_update + "<br>Position : " +
                                    addressfix + "<br> Jalur : " + response[0]
                                    .auto_last_road + "<br>" +
                                    "Coord : " + response[0].auto_last_lat +
                                    ", " + response[0].auto_last_long + "<br>" +
                                    "Engine : " + lastenginefix + "<br>" +
    ...
    function simultangomapsstandard() {
        ...
        jQuery("#loader2").show();
        jQuery.post("<?=base_url();?>map/mapsstandardlastinfoall", {
            companyid: companyid
        }, function(response) {
            jQuery("#loader2").hide();
            ...
            for (i = 0; i < objmapsstandard.length; i++) {
                var position = new google.maps.LatLng(parseFloat(objmapsstandardsimultan[i].auto_last_lat),
                    parseFloat(objmapsstandardsimultan[i].auto_last_long));
                bounds.extend(position);
    ...
    function getVehicleByContractor() {
        ...
        $.post("<?php echo base_url() ?>maps/vehicleByContractor", {
            companyid: companyid,
            valuemapsoption: 9999
        }, function(response) {
        ...
        if (mapsOptionsValue == "showHeatmap") {
            ...
            $.post("<?php echo base_url() ?>maps/vehicleByContractorheatmap", {
                companyid: companyid,
                valuemapsoption: valuemapsoption
            }, function(response) {
                jQuery("#loader2").hide();
                ...
                if (privilegecode == 5 || privilegecode == 6) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (vCompany == user_company || user_company == vehicle_id_shareto) {
                            ...
                            html += '<option value="' + data[i].vehicle_no + '">' + loop + ". " + data[i]
                                .vehicle_no + '</option>';
                            loop++;
                        }
                    }
                    ...
                    for (var i = 0; i < data.length; i++) {
                        if (companyid == 0) {
                            html += '<option value="' + data[i].vehicle_no + '">' + data[i].vehicle_no +
                                '</option>';
                        } else {
                            html += '<option value="' + data[i].vehicle_no + '">' + (i + 1) + ". " + data[i]
                                .vehicle_no + '</option>';
            ...
            $.post("<?php echo base_url() ?>maps/km_quickcount_new", {
                ...
                var datafixlimit = response.datafixlimit;
                var arraydatamuatan = Object.keys(datamuatan).map((key) => [String(key), datamuatan[key]]);
                var arraydatakosongan = Object.keys(datakosongan).map((key) => [String(key), datakosongan[
                    key]]);
                var dataMuatan2 = response.dataMuatan2;
                var dataKosongan2 = response.dataKosongan2;
                var arraydatamuatan2 = Object.keys(dataMuatan2).map((key) => [String(key), dataMuatan2[key]]);
                var arraydatakosongan2 = Object.keys(dataKosongan2).map((key) => [String(key), dataKosongan2[
                    key]]);
                var sizemuatan = arraydatamuatan.length;
                var sizekosongan = arraydatakosongan.length;
                var sizemuatan2 = arraydatamuatan2.length;
                ...
                for (var j = 0; j < dataPortfix.length; j++) {
                    ...
                    if (i == (dataPortfix.length - 1)) {
                        ...
                        htmlPortinQuickCount += '<td><div id="jumlahportbibplusturunan' + j + '"><b>' +
                            dataPortfix[j][1] + '&nbsp;|&nbsp;</b></div><td>';
                    } else {
                        if (dataPortfix[j][0] == "PORT BIB") {
                            jumlahDataInPortBIB += dataPortfix[j][1];
                        } else {
                ...
                for (var i = 0; i < sizemuatan; i++) {
                    var kmlist = arraydatamuatan[i][0];
                    var jumlahfix = arraydatamuatan[i][
                        1
                    ]; //arraydatamuatan[i][1]; //30+i; //arraydatamuatan[i][1];
                    totalMuatan += jumlahfix;
                    ...
                    for (var j = 0; j < totalkmallmuatan; j++) {
                        var mapsetting_name = dataallkmmuatan[j].mapsetting_name;
                        if (kmlist == mapsetting_name) {
                            var mapsetting_middle_limit_allkmmuatan = dataallkmmuatan[j]
                                .mapsetting_middle_limit;
                            var mapsetting_top_limit_allkmmuatan = dataallkmmuatan[j].mapsetting_top_limit;
                        } else {
                            var mapsetting_middle_limit_allkmmuatan = middle_limit;
                        ...
                        if (jumlahfix >= mapsetting_middle_limit_allkmmuatan && jumlahfix <
                            mapsetting_top_limit_allkmmuatan) {
                            $("#labelvehicleonmuatan" + i).addClass('timeline-badge btn btn-primary btn-lg');
                            $("#vehicleonmuatan" + i).addClass(
                                'timeline-badge3 btn btn-warning btn-md btn-circle');
                        } else if (jumlahfix >= mapsetting_top_limit_allkmmuatan) {
                            $("#labelvehicleonmuatan" + i).addClass('timeline-badge btn btn-primary btn-lg');
                            $("#vehicleonmuatan" + i).addClass(
                                'timeline-badge3 btn btn-danger btn-md btn-circle');
                        } else {
                            $("#labelvehicleonmuatan" + i).addClass('timeline-badge btn btn-primary btn-lg');
                            $("#vehicleonmuatan" + i).addClass(
                                'timeline-badge3 btn btn-success btn-md btn-circle');
                        }
            ...
            $.post("<?php echo base_url() ?>maps/getstreetautomaticbycompanyid", {
                ...
                for (var i = 0; i < totaldata; i++) {
                    ...
                    htmlrom += '</span>';
                    htmlrom += '<div class="info-box-content">';
                    htmlrom += '<span class="info-box-text" style="font-size:15px;">' + datainrom[i][0] +
                        '</span>';
                    htmlrom += '<span class="info-box-number" style="font-size:22px;"><b>' + datainrom[i][1] +
                        '</b></span>';
                    htmlrom += '</div>';
            ...
            $.post("<?php echo base_url() ?>maps/getstreetautomaticbycompanyid", {
                ...
                for (var j = 0; j < dataLimitInPort.length; j++) {
                    if (datainport[0][0] == dataLimitInPort[j].mapsetting_name_alias) {
                        ...
                        if (jumlahtotalInPortBib > middle_limit_in_port && jumlahtotalInPortBib <
                            top_limit_in_port) {
                            htmlportbib +=
                                '<h3 class="level-3 info-box bg-warning" onclick="listVehicleOnPort(' +
                                allStreet[0].street_id + ')" style="cursor : pointer;">';
                        } else if (jumlahtotalInPortBib >= top_limit_in_port) {
                            htmlportbib +=
                                '<h3 class="level-3 info-box bg-danger" onclick="listVehicleOnPort(' +
                                allStreet[0].street_id + ')" style="cursor : pointer;">';
                        } else {
                            htmlportbib += '<h3 class="level-3 info-box bg-blue" onclick="listVehicleOnPort(' +
                                allStreet[0].street_id + ')" style="cursor : pointer;">';
                ...
                htmlportbib += '<span class="info-box-number" style="font-size:20px;">' + datainport[0][0] +
                    '</span>';
                htmlportbib += '<span class="info-box-text" style="font-size:30px;"><b>' +
                    jumlahtotalInPortBib + '</b></span>';
                htmlportbib += '</div>';
                htmlportbib += '</h3>';
                htmlportbib += '<ol class="level-4-wrapper">';
                for (var i = 1; i < 8; i++) {
                    ...
                    for (var j = 0; j < dataLimitInPort.length; j++) {
                        if (datainport[i][0] == dataLimitInPort[j].mapsetting_name_alias) {
                            ...
                            if (datainport[i][1] > middle_limit_in_port && datainport[i][1] <
                                top_limit_in_port) {
                                htmlportbib +=
                                    '<h4 class="level-4 rectangle bg-warning" onclick="listVehicleOnPort(' +
                                    allStreet[i].street_id + ')" style="cursor : pointer;">';
                                ...
                                htmlportbib +=
                                    '<h4 class="level-4 rectangle bg-blue" onclick="listVehicleOnPort(' +
                                    allStreet[i].street_id + ')" style="cursor : pointer;">';
                            }
                        }
                    }
                ...
                for (var j = 0; j < dataLimitInPort.length; j++) {
                    if (datainport[0][0] == dataLimitInPort[j].mapsetting_name_alias) {
                        ...
                        if (jumlahtotalInPortBir > middle_limit_in_port && jumlahtotalInPortBir <
                            ...
                            htmlportbir +=
                                '<h3 class="level-3 info-box bg-warning" onclick="listVehicleOnPort(' +
                                allStreet[8].street_id + ')" style="cursor : pointer;">';
                        } else if (jumlahtotalInPortBir >= top_limit_in_port) {
                            htmlportbir +=
                                '<h3 class="level-3 info-box bg-danger" onclick="listVehicleOnPort(' +
                                allStreet[8].street_id + ')" style="cursor : pointer;">';
                ...
                htmlportbir += '</span>';
                htmlportbir += '<div class="info-box-content" style="color:white;">';
                htmlportbir += '<span class="info-box-number" style="font-size:20px;">' + datainport[8][0] +
                    '</span>';
                htmlportbir += '<span class="info-box-text" style="font-size:30px;"><b>' +
                    jumlahtotalInPortBir + '</b></span>';
                htmlportbir += '</div>';
                htmlportbir += '</h3>';
                htmlportbir += '<ol class="level-4-wrapper">';
                for (var i = 9; i < 14; i++) {
                ...
                for (var j = 0; j < dataLimitInPort.length; j++) {
                    if (datainport[14][0] == dataLimitInPort[j].mapsetting_name_alias) {
                        ...
                        if (datainport[14][1] > middle_limit_in_port && datainport[14][1] < top_limit_in_port) {
                            htmlportbbc +=
                                '<h3 class="level-3 info-box bg-warning" onclick="listVehicleOnPort(' +
                                allStreet[14].street_id + ')" style="cursor : pointer;">';
                ...
                htmlportbbc += '</span>';
                htmlportbbc += '<div class="info-box-content" style="color:white;">';
                htmlportbbc += '<span class="info-box-number" style="font-size:20px;">' + datainport[14][0] +
                    '</span>';
                htmlportbbc += '<span class="info-box-text" style="font-size:30px;"><b>' + datainport[14][1] +
                    '</b></span>';
                htmlportbbc += '</div>';
                htmlportbbc += '</h3>';
                htmlportbbc += '</li>';
                ...
                htmlporttia += '</span>';
                htmlporttia += '<div class="info-box-content" style="color:white;">';
                htmlporttia += '<span class="info-box-number" style="font-size:20px;">' + datainport[15][0] +
                    '</span>';
                htmlporttia += '<span class="info-box-text" style="font-size:30px;"><b>' + datainport[15][1] +
                    '</b></span>';
                htmlporttia += '</div>';
                htmlporttia += '</h3>';
                htmlporttia += '</li>';
            ...
            $.post("<?php echo base_url() ?>maps/getpoolnew", {
                ...
                for (var i = 0; i < totaldata; i++) {
                    jumlahtotalinpool += datainpool[i][1];
                    htmlpool += '<div class="col-xl-3 col-md-6 col-12" onclick="getPoolByParent(' + allcompany[
                        i].company_id + ')" style="cursor : pointer;">';
                    htmlpool += '<div class="info-box bg-blue">';
                    htmlpool += '<span class="info-box-icon push-bottom" style="margin-top:4%;">';
                    htmlpool +=
                        '<i class="material-icons" style="font-size:50px; padding-top:10px;">store_mall_directory</i>';
            ...
            $.post("<?php echo base_url() ?>maps/outOfHauling_quickcount", {
                ...
                var htmlchangeVList = document.getElementById('forsearchoutofhauling');
                htmlchangeVList.options[htmlchangeVList.options.length] = new Option(
                    'Vehicle List Out Of Hauling', "0");
                for (var i = 0; i < vehicle.length; i++) {
                    htmlchangeVList.options[htmlchangeVList.options.length] = new Option(vehicle[i].vehicle_no,
                        vehicle[i].vehicle_no);
                }
                ...
                for (i = 0; i < vehicle.length; i++) {
                    var position = new google.maps.LatLng(parseFloat(objoutofhauling[i].auto_last_lat),
                        parseFloat(objoutofhauling[i].auto_last_long));
                    bounds.extend(position);
                    ...
                    google.maps.event.addListener(marker, 'click', (function(marker, i) {
                        return function() {
                            ...
                            console.log("Out of hauling marker clicked ", data);
                            $.post("<?php echo base_url() ?>maps/getdetailbydevid", data,
                                function(response) {
                                    infowindowkedua.close();
                                    ...
                                    var string = response[0].vehicle_no + ' - ' + response[
                                            0].vehicle_name + "<br>" +
                                        "GPS Time : " + response[0].auto_last_update +
                                        "<br>Position : " + addressfix + "<br>" +
                                        "Coord : <a href='https://www.google.com/maps/search/?api=1&query=" +
                                        ...
                                        "</a></span></br>" +
                                        // "Coord : " + response[0].auto_last_lat + ", " + response[0].auto_last_long + "<br>" +
                                        "Engine : " + response[0].auto_last_engine +
                                        "<br>" +
                                        "Speed : " + rounded + " kph" + "<br> Ritase : " +
                                        ritasefix + "</br>" +
                                        "<div onclick='closeWindowOnMarkerOOH();' style='color:blue;cursor:pointer;'>Tutup Informasi</div>";
            ...
            $.post("<?php echo base_url() ?>maps/offlinevehicle_quickcount", {
                ...
                if (datafix.length > 0) {
                    ...
                    for (var i = 0; i < datafix.length; i++) {
                        ...
                        htmlofflinevehicle += '<tr>';
                        htmlofflinevehicle +=
                            '<td style="font-size:12px;color:black"><span style="color:black;">' + (i + 1) +
                            '</span>';
                        htmlofflinevehicle +=
                            '<td style="font-size:12px;color:black"><span style="color:black;">' + datafix[i]
                            .vehicle_no + " " + datafix[i].vehicle_name + '</span>';
                        // htmlofflinevehicle += '<td align="center" style="font-size:12px;color:black"><span style="color:black;">'+datafix[i].auto_last_engine+'</span>';
                        htmlofflinevehicle +=
                            '<td style="font-size:12px;color:black"><span style="color:black;">' +
                            lastupdatecetak + '</span>';
                        htmlofflinevehicle +=
                            '<td style="font-size:12px;color:black"><span style="color:black;">' + datafix[i]
                            .auto_last_positionfix + '</span>';
                        htmlofflinevehicle +=
                            '<td style="font-size:12px;color:black"><span style="color:black;"><a href="https://maps.google.com/?q=' +
                            datafix[i].auto_last_lat + "," + datafix[i].auto_last_long + '" target="_blank">' +
                            datafix[i].auto_last_lat + "," + datafix[i].auto_last_long + '</a></span>';
            ...
            $.post("<?php echo base_url() ?>maps/mapsstandard", {
                ...
                for (i = 0; i < objmapsstandard.length; i++) {
                    var position = new google.maps.LatLng(parseFloat(objmapsstandard[i].auto_last_lat),
                        parseFloat(objmapsstandard[i].auto_last_long));
                    bounds.extend(position);
                            ...
                            $.post("<?php echo base_url() ?>maps/getdetailbydevid", data,
                                function(response) {
                                    ...
                                    google.maps.event.addListener(marker, 'click', function(
                                        ...
                                        var sisaliterbensin, numfuel, roundfuel;
                                        if (objmapsstandard[i].vehicle_mv03 !=
                                            0000) {
                                            var numfuel = Number(response[0]
                                                .auto_last_fuel);
                                            var roundfuel = numfuel.toFixed(2);
                                        ...
                                        var inarea = response[0].auto_last_position
                                            .split(",");
                                        var addressfix = bibarea.includes(
                                            addresssplit[0]);
                                        if (addressfix) {
                                            var addressfix = inarea[0];
                                        } else {
                                        ...
                                        var string = response[0].vehicle_no +
                                            ' - ' + response[0].vehicle_name +
                                            "<br>" +
                                            "GPS Time : " + response[0]
                                            .auto_last_update + "<br>Position : " +
                                            addressfix + "<br> Jalur : " + response[
                                                0].auto_last_road + "<br>" +
                                            "Coord : " + response[0].auto_last_lat +
                                            ", " + response[0].auto_last_long +
                                            "<br>" +
                                            "Engine : " + response[0]
                                            .auto_last_engine + "<br>" +
                                            "Fuel : " + sisaliterbensin +
                                            " Ltr<br>" +
                                            "Speed : " + rounded + " kph" +
                                            "<br> Ritase : " + ritasefix + "</br>" +
                                            "<div onclick='closeWindowOnMarkerOOH();' style='color:blue;cursor:pointer;'>Tutup Informasi</div>";

                                        infowindowkedua = new google.maps
                                            .InfoWindow({
                                                content: string,
                                                maxWidth: 300
                                            });
...
if(isset($key) && $key != "") { ?>
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=<?php echo $key;?>&libraries=visualization&callback=initMap"
