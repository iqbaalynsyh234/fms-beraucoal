                ...
                <table class="table table-striped custom-table table-hover">
                  <thead>
                    <tr>
                      ...
                      <th style="text-align:center;" width="10%">Operator SID</th>
                      <th style="text-align:center;" width="10%">Operator Name</th>
                      <th style="text-align:center;" width="7%">Vehicle No</th>
                      <th style="text-align:center;" width="7%">Category</th>
                      <th style="text-align:center;" width="7%">Alert</th>
                      <th style="text-align:center;" width="7%">Shift</th>
                  ...
                  <tbody>
                    ...
                    for ($i=0;$i<count($data);$i++)
                    {
                      ...
                      <tr>
                        ...
                        <td style="text-align:center;font-size:12px;">
                          <?php echo date("d-m-Y",strtotime($data[$i]->berecord_date));?>
                        </td>
                        <td style="text-align:center;font-size:12px;">
                          <?php echo $data[$i]->berecord_operator_sid;?>
                        </td>
                        <td style="text-align:center;font-size:12px;">
                          <?php echo $data[$i]->berecord_operator_name;?>
                        </td>
                        <td style="text-align:center;font-size:12px;">
                          <?php echo $data[$i]->berecord_vehicle_no;?>
                        </td>
                        <td style="text-align:center;font-size:12px;">
                          <?php echo $data[$i]->berecord_alert_name;?>
                        </td>
                        <td style="text-align:center;font-size:12px;">
                          <?php echo $data[$i]->berecord_alert_name_detail;?>
                        </td>
                        <td style="text-align:center;font-size:12px;">
                          <?php echo $data[$i]->berecord_shift;?>
                        </td>
                        <td style="text-align:center;font-size:12px;">
                          <?php echo $data[$i]->berecord_total;?>
                        </td>
                        <td style="text-align:center;font-size:12px;">
                          <?php echo $data[$i]->berecord_remark;?>
                        </td>
                      </tr>
                    <?php }?>
                  </tbody>
