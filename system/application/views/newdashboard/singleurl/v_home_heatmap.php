...
<div class="page-content-wrapper">
        ...
        function appendthevehiclelist() {
            ...
            if (privilegecode == 5 || privilegecode == 6) {
                ...
                if (vCompany == user_company) {
                    html +=
                        '<option value="<?php echo $vehicledata[$i]['vehicle_no'] ?>"><?php echo $vehicledata[$i]['vehicle_no'] ?></option>';
                }
                html += '<?php } ?>';
            } else {
                html += '<option value="0">--Vehicle List</option>';
    ...
    function dataalert() {
        $.post("<?php echo base_url() ?>securityevidence/realtimealert", {
            ...
            if (response.code == 200) {
                ...
                for (var i = 0; i < realtimealertarraysummaryreverse.length - 1; i++) {
                    ...
                    htmlsummary += '<span style="font-size:11px; color:green;" onclik="forsearchfromalert("' +
                        ...
                        realtimealertarraysummaryreverse[i].vehicle_no +
                        '</span> <span style="font-size:11px; color:red;">' + realtimealertarraysummaryreverse[
                            i].gps_alert + '</span> <span style="font-size:11px;">' +
                        realtimealertarraysummaryreverse[i].gps_time +
...
if(isset($key) && $key != "") { ?>
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgPzlDKOewmk4yCSmb-C4oEN10Y2211oA<?php echo $key;?>&libraries=visualization&callback=initMap"
