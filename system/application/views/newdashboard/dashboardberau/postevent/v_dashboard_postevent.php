    ...
    <div class="row">
      <div class="col-md-12 col-sm-12" id="reportfilter">
        ...
        <div class="panel" id="panel_form">
          <header class="panel-heading" id="security-evidence">Dashboard Post Event</header>
              ...
              <div class="col-lg-4 col-md-3">
                  ...
                  $i = 1;
                   foreach ($data_driver as $rowdriver) {
                     ?>
                    <option value="<?php echo $rowdriver['karyawan_bc_sid'] ?>"><?php echo $i.'. '.$rowdriver['karyawan_bc_name'];?></option>
                  <?php $i++; } ?>
                </select>
              </div>
          </div>
  ...
  <div class="row">
    <div class="col-md-12">
        <div class="card card-topline-yellow">
            <div class="card-head">
                <header id="titleheader">Post Event</header>
                <div class="tools">
...
<script type="text/javascript">
  ...
  function frmsearch_onsubmit(){
    ...
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>dashboardberau/searchreport", jQuery("#frmsearch").serialize(), function(response){
      if (response.error) {
  ...
  function getalarmsubcategory(){
    ...
    $.post("<?php echo base_url() ?>dashboardberau/getalarmsubcat", data, function(response){
      console.log("response : ", response);
  ...
  function getdetailinfo(id){
    ...
    $.post("<?php echo base_url() ?>dashboardberau/getinfodetail_new", {alert_id : data[0], sdate : data[1]}, function(response){
	  $("#loadernya").hide();
  ...
  function modal_post_event(id){
   $("#loadernya").show();
    ...
    $.post("<?php echo base_url() ?>dashboardberau/postevent_detail", {alert_id : data[0], sdate : data[1], alarm_report_id : data[2], alarmtype : data[3]}, function(response){
    $("#loadernya").hide();
