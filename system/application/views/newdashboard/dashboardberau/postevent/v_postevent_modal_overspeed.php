...
<div class="row" style="overflow-x:auto; height:516px;">
  ...
  <div class="col-md-12">
     <!-- style="height:410px" -->
    <p class="text-center">
      <b>Pelaksanaan Post Event DMS OVERSPEED</b>
    </p>
    ...
    <div class="form">
      <table class="table table-striped" style="font-size:12px;">
        ...
        <tr>
          ...
          <td>
            <?php
            $control_room = $content[0]['alarm_report_name_cr'];
              // if ($control_room == "") {
              //   $control_room = $content[0]['alarm_report_name_up'];
              // }
             ?>
            <input type="text" name="postevent_name" id="postevent_name" class="form-control" value="<?php echo $control_room ?>" readonly>
          </td>
          ...
          <td>
            <?php
              $sid_pengawas = sizeof($sid_pengawas_from_config);
                if ($sid_pengawas > 0) {?>
                  <input type="text" name="postevent_sid" id="postevent_sid" value="<?php echo $sid_pengawas_from_config[0]['config_supervisor_id'].'|'.$sid_pengawas_from_config[0]['config_supervisor_name']; ?>" class="form-control" hidden>
...
$('.select2').each(function() {
  ...
  function btnSubmitIntervention(){
    ...
    if (alarm_true_false == undefined || postevent_alarm == undefined) {
      ...
      $.post("<?php echo base_url() ?>dashboardberau/submit_postevent_overspeed", data, function(response){
