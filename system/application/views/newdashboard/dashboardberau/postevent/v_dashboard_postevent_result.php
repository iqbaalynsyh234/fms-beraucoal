              ...
              <td>
                ...
                <a href='http://maps.google.com/maps?z=12&t=m&q=loc:<?php echo $coordstart ?>' target='_blank'><?php echo $coordstart ?></a>
                  ...
                  $alarm_report_statusintervention_cr = $content[$i]['alarm_report_statusintervention_cr'];
                    ...
                    <?php
                      if ($this->sess->user_login == "XIIKM" || $this->sess->user_login == "XIIKM1") {?>
                          <?php
                ...
                <?php
                  $alarm_report_statusintervention_cr = $content[$i]['alarm_report_statusintervention_cr'];
                    if ($alarm_report_statusintervention_cr == 1 || $alarm_report_statusintervention_cr == 2) {?>
                      <button type="button" class="btn btn-warning" onclick="modal_post_event('<?php echo $content[$i]['alarm_report_vehicle_id'].','.$content[$i]['alarm_report_start_time'].','.$content[$i]['alarm_report_id'].','.$content[$i]['alarm_report_type']; ?>');" title="Post Event">
