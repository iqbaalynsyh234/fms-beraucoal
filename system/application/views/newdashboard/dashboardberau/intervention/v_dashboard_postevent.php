    ...
    <div class="row">
      <div class="col-md-12 col-sm-12" id="reportfilter">
        ...
        <div class="panel" id="panel_form">
          <header class="panel-heading" id="security-evidence">Dashboard Intervention - Control Room</header>
...
<script type="text/javascript">
  ...
  function frmsearch_onsubmit(){
    ...
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>dashboardberau/searchreport_controlroom", jQuery("#frmsearch").serialize(), function(response){
      if (response.error) {
  ...
  function modal_post_event_controlroom(id){
   $("#loadernya").show();
    ...
    $.post("<?php echo base_url() ?>dashboardberau/intervention_detail_controlroom", {alert_id : data[0], sdate : data[1], alarm_report_id : data[2], alarmtype : data[3]}, function(response){
    $("#loadernya").hide();
