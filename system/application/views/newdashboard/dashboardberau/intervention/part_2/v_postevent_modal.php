      ...
      <div class="row">
        ...
        <table style="font-size:12px">
          <tr>
            <td>Alert</td>
            <td>
              <p style="font-size:10px;"><?php echo $content[0]['alarm_report_name'] ?></p>
            </td>
            <td>SID</td>
            <td>
              <?php
          ...
          <tr>
            ...
            <td>
              ...
              $intervention_category = explode("|", $content[0]['alarm_report_intervention_category_cr']);
               ?>
              <input type="text" name="intervention_category" id="intervention_category" value="<?php echo $intervention_category[1]; ?>" class="form-control" readonly>
...
$('.select2').each(function() {
  ...
  function btnSubmitIntervention(){
    ...
    if (intervention_sid == undefined || intervention_sid == "") {
      ...
      $.post("<?php echo base_url() ?>dashboard_intervensi_postevent/submit_intervention_controlroom", data, function(response){
