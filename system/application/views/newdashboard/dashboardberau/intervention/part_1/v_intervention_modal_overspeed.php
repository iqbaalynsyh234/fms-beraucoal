    ...
    <div class="form">
      <table class="table table-striped" style="font-size:12px;">
        <tr>
          ...
          <td>
            <?php
              echo "Overspeed - ". $content[0]['alarm_report_level_alias'];
             ?>
          </td>
          <td></td>
          <td></td>
          <!-- <td>SID</td> -->
          <!-- <td>
            <input type="text" name="itervention_sid" id="itervention_sid" value="<?php echo $data_karyawan[0]['karyawan_bc_sid']; ?>" class="form-control" readonly>
...
$('.select2').each(function() {
  ...
  function btnSubmitIntervention(){
    ...
    if (alarm_true_false == undefined || alarm_true_false == "") {
      ...
      $.post("<?php echo base_url() ?>dashboard_intervensi_postevent/submit_intervention_controlroom_overspeed", data, function(response){
  ...
  function change_type_intervention(){
    ...
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent/data_intervention_note", data, function(response){
