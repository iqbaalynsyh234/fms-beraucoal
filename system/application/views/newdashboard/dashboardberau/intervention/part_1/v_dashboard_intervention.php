        ...
        <div class="panel" id="panel_form">
          ...
          <div class="panel-body" id="bar-parent10">
            <form class="form-horizontal" name="frmsearch" id="frmsearch" onsubmit="frmsearch_onsubmit();">
              ...
              <input type="text" name="time_alert" id="time_alert" hidden>
...
<div id="modalposteventsubmit" style="display: none; width:100%; font-size:11px;">
...
<script type="text/javascript">
  ...
  function btnSubmitConfig(){
    ...
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent/submit_intervention_config", data, function(response){
  ...
  function modalinfodetail(){
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent/check_isinput_intervention_config", {}, function(response){
  ...
  function frmsearch_onsubmit(){
    ...
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent/searchreport_controlroom", data, function(response){
      if (response.error) {
        alert(response.message)
    		// $("#result").hide();
    		$("#loadernya").hide();
      }else {
        console.log("response : ", response.time_alert);
        var time_alert_field    = $("#time_alert").val();
        // var time_alert_field    = 123;
        var time_alert_response = response.time_alert;
        if (time_alert_field != time_alert_response) {
          playsound();
          $("#time_alert").val(time_alert_response);
        }
    		$("#result").show();
        $("#loadernya").hide();
        ...
        $("#resultreport").show();
        $("#last_refresh").html("");
        $("#last_refresh").html("Last Refresh : " + response.last_refresh + " | Pengawas : " + response.pengawas_sid + " / " + response.pengawas_name);
        $("#last_refresh").show();
        console.log("response : ", response);
      }
    }, "json");
  ...
  function playsound() {
    ...
    var audio = new Audio('https://fmspoc.abditrack.com/assets/sounds/notif_intervensi.mp3');
      audio.play();
  ...
  function getalarmsubcategory(){
    ...
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent/getalarmsubcat", data, function(response){
      console.log("response : ", response);
  ...
  function getdetailinfo(id){
    ...
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent/getinfodetail_new", {alert_id : data[0], sdate : data[1]}, function(response){
	  $("#loadernya").hide();
  ...
  function modal_intervention_controlroom(id){
   $("#loadernya").show();
    ...
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent/intervention_detail_controlroom", {alert_id : data[0], sdate : data[1], alarm_report_id : data[2], alarmtype : data[3], alarm_report_imei : data[4]}, function(response){
    $("#loadernya").hide();
  ...
  function modal_intervention_controlroom_p1(id){
   $("#loadernya").show();
    ...
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent/intervention_detail_controlroom_p1", {alert_id : data[0], sdate : data[1], alarm_report_id : data[2], alarmtype : data[3], alarm_report_imei : data[4]}, function(response){
    $("#loadernya").hide();
      console.log("response intervention_detail_controlroom: ", response);
      $("#contentpostevent").html(response.html);
      $("#modalposteventsubmit").show();
  ...
  //   console.log("sdate detail : ", data[1]);
  //
  //   $.post("<?php echo base_url() ?>dashboard_intervensi_postevent/getinfodetail", {alert_id : data[0], sdate : data[1]}, function(response){
	//   $("#loadernya").hide();
  //     console.log("response getdetailinfo: ", response);
  //     $("#contentinformationdetail").html(response.html);
  //     $("#modalinformationdetail").show();
