        ...
        <thead>
          <tr>
            ...
            <th>Coordinate</th>
      			...
      			<th>Interv By</th>
            <th>Interv Cat</th>
            <!-- <th>Interv DateTime</th> -->
            <th>Fatigue Category</th>
            <th>Note CR</th>
      			<th>Note Pengawas</th>
            <!-- <th width="10px">Image Link</th>
            <th width="5px">Video Link</th> -->
        ...
        <tbody>
          <?php $no = 1; for ($i=0; $i < sizeof($content); $i++) {
            ...
            <tr>
              ...
              <!-- <?php
              if ($content[$i]['alarm_report_name'] == "Overspeed") {?>
                <td style="color:red;"><?php echo $content[$i]['alarm_report_'] ?></td>
              <?php }else {?>
                <td style="color:red;"><?php echo $content[$i]['alarm_report_name'] ?></td>
              <?php } ?> -->
			  ...
			  <!--<td><?php echo $content[$i]['alarm_report_speed'] ?>
               ...
               <?php
               $alarm_geofence = explode("-", $content[$i]['alarm_report_geofence']);
                ?>
               <td><?php echo $alarm_geofence[0] ?></td>
              ...
              <td>
                ...
                <a href='http://maps.google.com/maps?z=12&t=m&q=loc:<?php echo $coordstart ?>' target='_blank'><?php echo $coordstart ?></a>
	              <!-- <?php echo $coordstart ?> -->
  					...
  					<?php
              $alarm_report_truefalse_up = $content[$i]['alarm_report_truefalse_up'];
                if ($alarm_report_truefalse_up == 0) {?>
                    <td style="background-color:red;">
                    <?php echo "<p style='color:white;font-size:11px;'>Belum Diintervensi</p>";?>
                <?php }elseif ($alarm_report_truefalse_up == 1) {?>
                  <td style="background-color:green;">
                  <?php echo "<p style='color:white;font-size:11px;'>True</p>";?>
                <?php }else { ?>
                    <td style="background-color:yellow;">
                    <?php echo "<p style='color:black;font-size:11px;'>False</p>";?>
                  <?php }?>
                </td>
            ...
            <?php
              $alarm_report_intervention_category_cr = $content[$i]['alarm_report_intervention_category_cr'];
                ...
                <!-- <td>
                  <?php
                  if ($content[$i]['alarm_report_datetime_cr'] == "") {
                    $datetime_cr = "";
                  }else {
                    $datetime_cr = date("Y-m-d H:i:s", strtotime($content[$i]['alarm_report_datetime_cr'] . "+1 Hour"));
                  }
                   echo $datetime_cr ?>
                </td> -->
                ...
                // FILTER ALERT KHUSUS FATIGUE
                    ...
                    $alarm_report_type = $content[$i]['alarm_report_type'];
                    ...
                    <?php }elseif ($fatigue_category == "") {?>
                      <td style="background-color:red;">
                        <p style='color:white;font-size:11px;'>
                          <?php
                          if ($alarm_report_type == 618 || $alarm_report_type == 619) {
                            echo "Fatigue";
                          }else {
                    ...
                    <?php
                      ...
                      <?php
                        ...
                        <!-- <td>
                          <p style='font-size:10px;'><?php echo $content[$i]['alarm_report_image_link'] ?></p>
                        </td>

                        <td>
                          <p style='font-size:10px;'><?php echo $content[$i]['alarm_report_video_link'] ?></p>
                        </td> -->


      				<td id="detaildatatd<?php echo $i?>">
                <?php if ($content[$i]['alarm_report_type'] == "Overspeed") {?>
                    <button type="button" class="btn btn-warning" onclick="modal_post_event_controlroom('<?php echo $content[$i]['alarm_report_vehicle_id'].','.$content[$i]['alarm_report_start_time'].','.$content[$i]['alarm_report_id'].','.$content[$i]['alarm_report_type']; ?>');" title="Intervention">
