      ...
      <table class="table table-striped table-bordered" style="font-size: 11px; overflow-y:auto;">
        ...
        <tbody>
          <?php $no = 1; for ($i=0; $i < sizeof($content); $i++) {
            ...
            <?php
              $alarm_report_supervisor_name = $content[$i]['alarm_report_supervisor_name'];
                if ($alarm_report_supervisor_name == "") {
                  ?>
                    <td style="background-color:red;">
                    <?php echo "<p style='color:white;font-size:11px;'>Belum Diintervensi</p>";?>
                <?php }else {
                  ...
                  ?>
                    <td style="background-color:green;">
                    <?php echo "<p style='color:white;font-size:11px;'>".$alarm_report_supervisor_name."</p>";?>
                  <?php }?>
                </td>
