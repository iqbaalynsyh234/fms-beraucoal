    ...
    <div class="row">
      <div class="col-md-12 col-sm-12" id="reportfilter">
        ...
        <div class="panel" id="panel_form">
          <header class="panel-heading" id="security-evidence">Report Manual Evidence</header>
...
<script type="text/javascript">
  ...
  function frmsearch_onsubmit(){
    ...
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>live_monitoring/search_manual_evidence", jQuery("#frmsearch").serialize(), function(response){
      if (response.error) {
  ...
  function getalarmsubcategory(){
    ...
    $.post("<?php echo base_url() ?>live_monitoring/getalarmsubcat", data, function(response){
      console.log("response : ", response);
