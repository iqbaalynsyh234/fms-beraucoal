                            ...
                            <table class="table table-striped" style="font-size:12px;">
                              ...
                              <tr>
                                ...
                                <tr>
                                  <td>Remark</td>
                                  <td>
                                    <textarea name="manual_evidence_remarks" id="manual_evidence_remarks" rows="8" cols="20"></textarea>
                                  </td>
                                  <td></td>
                                  <td></td>
                                </tr>
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-head" style="background-color:#221f1f; color:white;">
            <header>
              <h5>Dashboard Live Monitoring</h5>
            </header>
            <div class="tools">
              <!-- <a class="fa fa-repeat btn-color box-refresh" href="javascript:;"></a> -->
              <a class="t-collapse btn-color fa fa-chevron-down" href="javascript:;"></a>
...
<script>
  ...
  function stream_by_mitra(){
    ...
    jQuery("#loader2").show();
    $.post("<?php echo base_url() ?>live_monitoring/get_stream_by_mitra", data, function(r){
      jQuery("#loader2").hide();
...
function forsearchinput(){
  var deviceid = $("#searchnopol").val();
    ...
    // }else {
      ...
      jQuery("#loader2").show();
      $.post("<?php echo base_url() ?>live_monitoring/forsearchvehicle", data, function(r){
        jQuery("#loader2").hide();
        console.log("ini respon pencarian : ", r);
        if (r.isshowvideo == 1) {
          $("#textisshowvideo").hide();
