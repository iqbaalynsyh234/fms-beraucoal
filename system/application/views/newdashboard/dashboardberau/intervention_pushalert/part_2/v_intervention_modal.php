      ...
      <div class="row">
        ...
        <table style="font-size:12px">
          ...
          <tr>
            <?php
            $alert_name = "fatigue";
            $isfatigue = strpos($alert_name, $content[0]['alarm_report_name']);
              if ($isfatigue === true) {?>
                <td>
                  Fatigue Category
                </td>
...
$('.select2').each(function() {
  ...
  function btnSubmitIntervention(){
    ...
    if (intervention_sid == undefined || intervention_sid == "") {
      ...
      $.post("<?php echo base_url() ?>dashboard_intervensi_postevent_pushalert/submit_intervention_controlroom", data, function(response){
