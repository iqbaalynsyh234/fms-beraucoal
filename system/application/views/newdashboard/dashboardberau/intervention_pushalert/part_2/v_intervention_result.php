...
jQuery(document).ready(
  function()
  {
    jQuery("#export_xcel").click(function() {
      ...
      link.download = "Pushalert_part_II.csv";
      link.click();
          ...
          <?php $no = 1; for ($i=0; $i < sizeof($content); $i++) {
            ...
            <tr>
              ...
              $alarm_report_truefalse_up = $content[$i]['alarm_report_truefalse_up'];
                if ($alarm_report_truefalse_up == 1) {?>
                    <td style="background-color:green;">
                    <?php echo "<p style='color:white;font-size:11px;'>True</p>";?>
                <?php }elseif ($alarm_report_truefalse_up == 2) {?>
            ...
            <?php
              $alarm_report_spvname_cr = $content[$i]['alarm_report_spvname_cr'];
                if ($alarm_report_spvname_cr == "") {?>
                    <td style="background-color:red;">
                    <?php echo "<p style='color:white;font-size:11px;'>Belum Diintervensi</p>";?>
                <?php }else { ?>
                    <td style="background-color:green;">
                    <?php echo "<p style='color:white;font-size:11px;'>".$alarm_report_spvname_cr."</p>";?>
                  <?php }?>
                </td>
              ...
              $alarm_report_intervention_category_cr = $content[$i]['alarm_report_intervention_category_cr'];
                ...
                <?php }else {
                  $alarm_report_intervention_category_crfix = explode("|", $content[$i]['alarm_report_intervention_category_cr']);
                    if (isset($alarm_report_intervention_category_crfix[1])) {
                      $intervention_category_show = $alarm_report_intervention_category_crfix[1];
                    }else {
                      $intervention_category_show = $content[$i]['alarm_report_intervention_category_cr'];
                    }
                  ?>
                    <td style="background-color:green;">
                    <?php echo "<p style='color:white;font-size:11px;'>".$intervention_category_show."</p>";?>
                  <?php }?>
                </td>

                <td>
                  <?php echo $content[$i]['alarm_report_datetime_cr'] ?>
                </td>
                ...
                // FILTER ALERT KHUSUS FATIGUE
                    ...
                    if ($fatigue_category == "0" || $fatigue_category == "") {?>
                      <td>
                    ...
                    <?php
                      ...
                      <?php
                        ...
                        <td>
                          <a href="<?php echo $content[$i]['alarm_report_image_link'] ?>" target="_blank"><?php echo $content[$i]['alarm_report_image_link'] ?></a>
                        </td>
         			         <td>
                         <a href="<?php echo $content[$i]['alarm_report_video_link'] ?>" target="_blank"><?php echo $content[$i]['alarm_report_video_link'] ?></a>
                       </td>
