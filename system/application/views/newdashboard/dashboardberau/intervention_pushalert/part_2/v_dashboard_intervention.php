      ...
      <div class="col-md-12 col-sm-12" id="reportfilter">
        ...
        <div class="panel" id="panel_form">
          <header class="panel-heading" id="security-evidence">
            Dashboard Intervention Pushalert - Control Room Part II DEVELOPMENT
          </header>
          <div class="panel-body" id="bar-parent10">
            ...
            <div class="form-group row">
              <label class="col-lg-3 col-md-4 control-label">Provider
              </label>
              <div class="col-lg-4 col-md-3">
                  ...
                  <?php
                  $i = 1;
                   foreach ($data_vendor as $rowvendor) {
                     ?>
                    <option value="<?php echo $rowvendor['api_note'] ?>"><?php echo $i.'. '.$rowvendor['api_note'] ?></option>
                  <?php $i++; } ?>
                </select>
              </div>
          </div>
...
<script type="text/javascript">
  ...
  function frmsearch_onsubmit(){
    ...
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent_pushalert/searchreport_controlroom_2", jQuery("#frmsearch").serialize(), function(response){
      if (response.error) {
