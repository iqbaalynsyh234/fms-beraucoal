      ...
      <div class="col-md-12 col-sm-12" id="reportfilter">
        ...
        <div class="panel" id="panel_form">
          <header class="panel-heading" id="security-evidence">
            Dashboard Intervention Pushalert
...
<script type="text/javascript">
  ...
  function btnSubmitConfig(){
    ...
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent_pushalert/submit_intervention_config", data, function(response){
  ...
  function modalinfodetail(){
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent_pushalert/check_isinput_intervention_config", {}, function(response){
  ...
  function frmsearch_onsubmit(){
    ...
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent_pushalert/searchreport_controlroom", data, function(response){
      if (response.error) {
  ...
  function getalarmsubcategory(){
    ...
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent_pushalert/getalarmsubcat", data, function(response){
      console.log("response : ", response);
  ...
  function getdetailinfo(id){
    ...
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent_pushalert/getinfodetail_new", {alert_id : data[0], sdate : data[1]}, function(response){
	  $("#loadernya").hide();
  ...
  function modal_intervention_controlroom(id){
   $("#loadernya").show();
    ...
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent_pushalert/intervention_detail_controlroom", {alert_id : data[0], sdate : data[1], alarm_report_id : data[2], alarmtype : data[3], alarm_report_imei : data[4]}, function(response){
    $("#loadernya").hide();
  ...
  function modal_intervention_controlroom_p1(id){
   $("#loadernya").show();
    ...
    $.post("<?php echo base_url() ?>dashboard_intervensi_postevent_pushalert/intervention_detail_controlroom_p1", {alert_id : data[0], sdate : data[1], alarm_report_id : data[2], alarmtype : data[3], alarm_report_imei : data[4]}, function(response){
    $("#loadernya").hide();
      console.log("response intervention_detail_controlroom: ", response);
      $("#contentpostevent").html(response.html);
      $("#modalposteventsubmit").show();
  ...
  //   console.log("sdate detail : ", data[1]);
  //
  //   $.post("<?php echo base_url() ?>dashboard_intervensi_postevent_pushalert/getinfodetail", {alert_id : data[0], sdate : data[1]}, function(response){
	//   $("#loadernya").hide();
  //     console.log("response getdetailinfo: ", response);
  //     $("#contentinformationdetail").html(response.html);
  //     $("#modalinformationdetail").show();
