...
<div class="row">
  ...
  <div class="col-lg-12 col-md-5 col-sm-12">
	<figure class="highcharts-figure" style="background-color: white; padding:1px;">
		<table class="table table-striped custom-table table-hover">
								<thead>
									<tr>
										
										<th width="5%" valign="top" style="text-align:center;font-size:12px">Undefined</th>
										<th width="5%" valign="top" style="text-align:center;font-size:12px">False</th>
										<th width="5%" valign="top" style="text-align:center;font-size:12px">True</th>
										<th width="5%" valign="top" style="text-align:center;font-size:12px">Total</th>
									...
									<tr>
										...
										<td valign="top" style="text-align:center;font-size:12px">
											<?=round($persen_total,0);?> %
										</td>
									</tr>
									<tr>
										<td colspan="4" valign="top" style="text-align:right;font-size:8px" >
											*true berdasarkan pelanggaran
										</td>
									</tr>
									<tr>
										<th colspan="2" width="5%" valign="top" style="text-align:center;font-size:12px">BeHazard</th>
										<th colspan="2" width="5%" valign="top" style="text-align:center;font-size:12px">BeRecord</th>
									</tr>
									<tr>
										<td colspan="2" valign="top" style="text-align:center;font-size:12px">
											<?=$gtotal_hazard?>
										</td>
										<td colspan="2" valign="top" style="text-align:center;font-size:12px">
											<?=$gtotal_record?>
                ...
                <div id="viewtable" style="height: 95%;">
                    <div id="isexport_xcel">
                        <div style="margin: 3px; padding:3px;">
                            <b id="exceltitle" style="font-size: 12px;">Summary Alert (<?= $date; ?>)</b>
                            ...
                            switch (this.series.options.level) {
                                ...
                                case 2:
                                    ...
                                    this.series.chart.setTitle({
                                        ...
                                        text: "<b>Hour " + exp[1] + " > " + exp[2] + " > " + exp[3] + "</b><br>Dashboard Trend Alert<br>" + date
                                    });
                                    return this.y;
                                    break;
                            }
                            ...
                            switch (this.series.options.level) {
                                ...
                                case 2:
                                    ...
                                    this.series.chart.setTitle({
                                        ...
                                        text: "<b>Hour " + exp[1] + " > " + exp[2] + " > " + exp[3] + " Overspeed </b><br>Dashboard Trend Alert<br>" + date
                                    });
                                    return this.y;
                                    break;
                            }
