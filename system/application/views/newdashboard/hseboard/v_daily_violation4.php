...
<script>
    ...
    function page() {
        ...
        jQuery.post("<?= base_url(); ?>hseboard/search_violation4", jQuery("#frmsearch").serialize(),
            function(r) {
                if (r.error) {
                    console.log(r);
                    alert(r.message);
    ...
    function company_onchange() {
        ...
        var site = "<?= base_url() ?>hseboard/get_vehicle_by_company/" + dc[0];
        jQuery.ajax({
            url: site,
...
<script type="text/javascript">
    function showinfo(sdate = null, edate = null, company = null, company_name = null, violation = null) {
        ...
        jQuery("#loader2").show();
        jQuery.post("<?= base_url(); ?>hseboard/infodetail2", data,
            function(r) {
                if (r.error) {
                    jQuery("#loader2").hide();
                    alert("Data empty!");
