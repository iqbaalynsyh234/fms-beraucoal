...
function company_onchange() {
    ...
    if (data_company == 0) {
        ...
        jQuery("#vehicle").html(
            "<option value='0' selected='selected' class='form-control'>--Select Vehicle--</option>");
    } else {
                ...
                <div class="panel" id="panel_form">
                    ...
                    <div class="panel-body" id="bar-parent10">
                        <form class="form-horizontal" name="frmsearch" id="frmsearch" onsubmit="frmsearch_onsubmit();">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-3">
                                    <select class="form-control select2" id="company" name="company"
                                        onchange="javascript:company_onchange()">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-3">
                                    <select id="vehicle" name="vehicle" class="form-control select2">
                                        ...
                                        ?>
                                        <option value="<?php echo $rowvehicle['vehicle_mv03'] ?>">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-md-4 control-label">Driver
                                </label>
                                <div class="col-lg-4 col-md-3">
                                    <select id="data_driver" name="data_driver" class="form-control select2">
                                        <option value="all">--All Driver</option>
                                        <?php
                                        $i = 1;
                                        foreach ($data_driver as $rowdriver) {
                                            ?>
                                        <option value="<?php echo $rowdriver['karyawan_bc_sid'] ?>">
                                            <?php echo $i.'. '.$rowdriver['karyawan_bc_name'];?></option>
                                        <?php $i++; } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-3">
                                    <select id="filter_true_false" name="filter_true_false"
                            ...
                            <div class="form-group row" id="mn_vehicle">
                                ...
                                <div class="col-lg-4 col-md-3">
                                    <input class="form-control" size="5" type="text" name="km" id="km" value=""
                                        placeholder="ex: 5 / 6.5">
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <select id="alarmtype" name="alarmtype" class="form-control select2" required>
                                     ...
                                     <?php } ?> -->
                                        ...
                                        <?php foreach ($alarmtype as $rowalarmtype) {?>
                                        <option value="<?php echo $rowalarmtype['alarmmaster_id'] ?>">
                                            <?php echo $rowalarmtype['alarmmaster_name'] ?></option>
                                        <?php } ?>
                            ...
                            <div class="form-group row" id="mn_vehicle">
                                ...
                                <div class="col-lg-4 col-md-3">
                                    <select id="periode" name="periode" id="periode" class="form-control select2"
                                        onchange="javascript:periode_onchange()">
                            ...
                            <div class="form-group row" id="mn_sdate" style="display:none">
                                ...
                                <div class="input-group date form_date col-md-4" data-date=""
                                    ...
                                    <input class="form-control" size="5" type="text" readonly name="startdate"
                                        id="startdate" value="<?=date('d-m-Y',strtotime("yesterday") )?>">
                                    <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                </div>
                                <input type="hidden" id="dtp_input2" value="" />

                                <div class="input-group date form_time col-md-2" data-date="" data-date-format="hh:ii"
                                    data-link-field="dtp_input3" data-link-format="hh:ii">
                                    <input class="form-control" size="5" type="text" readonly id="shour" name="shour"
                            ...
                            <div class="form-group row" id="mn_edate" style="display:none">
                                ...
                                <div class="input-group date form_date col-md-4" data-date=""
                                    data-date-format="dd-mm-yyyy" data-link-field="dtp_input2"
                                    data-link-format="yyyy-mm-dd">
                                    <input class="form-control" size="5" type="text" readonly name="enddate"
                                        id="enddate" value="<?=date('d-m-Y',strtotime("yesterday") )?>">
                                    <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                </div>
                                <input type="hidden" id="dtp_input2" value="" />
                                <div class="input-group date form_time col-md-2" data-date="" data-date-format="hh:ii"
                                    data-link-field="dtp_input3" data-link-format="hh:ii">
                                    <input class="form-control" size="5" type="text" readonly id="ehour" name="ehour"
              ...
              <div id="thisissubcategoryview"></div>-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3 col-md-3">
                                <button class="btn btn-circle btn-success" id="btnsearchreport" type="button"
                                    onclick="frmsearch_onsubmit();" />Search</button>
                                <img src="<?php echo base_url();?>assets/transporter/images/loader2.gif"
                                    style="display: none;" id="loadernya">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-topline-yellow">
                <div class="card-head">
                    <header id="titleheader">Form Post Event</header>
                    <div class="tools">
                        <a class="fa fa-repeat btn-color box-refresh" href="javascript:;"></a>
                        <a class="t-collapse btn-color fa fa-chevron-down" href="javascript:;"></a>
                        <button type="button" class="btn btn-danger" name="button"
                            onclick="closemodalposteventsubmit();">X</button>
                    </div>
                </div>
                <div class="card-body">
...
function frmsearch_onsubmit() {
    ...
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>development/searchreport_postevent", jQuery("#frmsearch").serialize(), function(
        response) {
        if (response.error) {
...
function getalarmsubcategory() {
    ...
    $.post("<?php echo base_url() ?>development/getalarmsubcat", data, function(response) {
        ...
        for (var i = 0; i < response.alarmsubcategory.length; i++) {
            html += '<option value="' + response.alarmsubcategory[i].webtracking_alarmsubcategory_id + '">' +
                response.alarmsubcategory[i].webtracking_alarmsubcategory_name + '</option>';
        }
        html += '</select>';
        html += '</div>';
        html += '</div>';
...
function getdetailinfo(id) {
    ...
    $.post("<?php echo base_url() ?>development/getinfodetail_new", {
        alert_id: data[0],
        sdate: data[1]
    }, function(response) {
        $("#loadernya").hide();
...
function modal_post_event(id) {
    ...
    $.post("<?php echo base_url() ?>development/postevent_detail", {
        alert_id: data[0],
        sdate: data[1],
        alarm_report_id: data[2],
        alarmtype: data[3]
    }, function(response) {
        $("#loadernya").hide();
        console.log("response postevent_detail : ", response);
