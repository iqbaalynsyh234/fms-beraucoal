      ...
      <div class="row">
        <div class="col-md-6">
          <table class="table table-striped" style="font-size:12px;">
            ...
            <?php } ?> -->
            <input type="text" name="intervention_date" id="intervention_date" class="form-control" value="<?php echo date("Y-m-d H:i:s") ?>" hidden>
            <tr>
              <td>
...
$('.select2').each(function() {
  ...
  function btnSubmitIntervention(){
    ...
    if (alarm_true_false == undefined) {
      ...
      $.post("<?php echo base_url() ?>development/submit_intervention_controlroom_p1", data, function(response){
