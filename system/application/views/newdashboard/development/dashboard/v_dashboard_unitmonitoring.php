...
<div class="page-content-wrapper">
                                        ...
                                        <div class="panel-body">
                                            <div class="row text-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <button type="button" class="btn btn-flat" id="btnonline"
                                                        style="font-size:16px;">15</button>
                                                </div>

                                                <div class="col-md-4">
                                                    <label for="btnwithoutalert">No Alert</label><br>
                                                    <button type="button" class="btn btn-success" id="btnwithoutalert"
                                                        style="font-size:16px;">10</button>
                                                </div>

                                                <div class="col-md-4">
                                                    <label for="btnwithalert">With Alert</label><br>
                                                    <button type="button" class="btn btn-danger" id="btnwithalert"
                                                        style="font-size:16px;">5</button>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
    ...
    <?php
// $key = $this->config->item("AIzaSyAgPzlDKOewmk4yCSmb-C4oEN10Y2211oA");
