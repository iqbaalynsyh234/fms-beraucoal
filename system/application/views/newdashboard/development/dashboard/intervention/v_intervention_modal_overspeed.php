...
<div class="row" style="overflow-x:auto; height:516px;">
  ...
  <div class="col-md-12">
     <!-- style="height:410px" -->
    <p class="text-center">
      <b>Pelaksanaan Intervensi DMS OVERSPEED -  DEVELOPMENT EXISTING</b>
    </p>
...
$('.select2').each(function() {
  ...
  function btnSubmitIntervention(){
    ...
    var intervention_note       = $('#intervention_note').val();
      ...
      $.post("<?php echo base_url() ?>development/submit_intervention_overspeed_existing", data, function(response){
