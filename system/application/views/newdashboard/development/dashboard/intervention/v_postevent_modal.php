...
<div class="row" style="overflow-x:auto; height:516px;">
  ...
  <div class="col-md-12">
     <!-- style="height:410px" -->
    <p class="text-center">
      <b>Pelaksanaan Intervensi DMS - DEVELOPMENT EXISTING</b>
    </p>
...
$('.select2').each(function() {
  ...
  function btnSubmitIntervention(){
    ...
    if (itervention_sid == undefined || itervention_sid == "") {
      ...
      $.post("<?php echo base_url() ?>development/submit_intervention_existing", data, function(response){
  ...
  function change_type_intervention(){
    ...
    $.post("<?php echo base_url() ?>development/data_note_existing", data, function(response){
