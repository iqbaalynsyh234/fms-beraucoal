<?php
		...
		$config['license'] = "fmspoc.abditrack.com";
		//$config['login'] = "http://transporter.abditrack.com";
		...
		$config['GOOGLE_MAP_API_KEY'] = "AIzaSyA2SXUIwMBS5Y-ufnD2v_cSnUfLhqAtoKw"; //mitratrans
		//$config['GOOGLE_MAP_API_KEY'] = "AIzaSyDIYd_Eh2p_wUrlUNEcPwD82FHxIYfTVEM"; //PREMIUM ABDITRACK
